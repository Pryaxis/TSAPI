	...
	public class Player
	{
		...
		public void ItemCheck(int i)
		{
			...
			if (i == Main.myPlayer)
			{
				...
				{
					int num59 = this.inventory[this.selectedItem].shoot;
					float num60 = this.inventory[this.selectedItem].shootSpeed;
					if (this.inventory[this.selectedItem].melee && num59 != 25 && num59 != 26 && num59 != 35)
					{
						num60 /= this.meleeSpeed;
					}
					bool flag7 = false;
					int num61 = num2;
					float num62 = this.inventory[this.selectedItem].knockBack;
					if (num59 == 13 || num59 == 32 || num59 == 315 || (num59 >= 230 && num59 <= 235) || num59 == 331)
					{
						this.grappling[0] = -1;
						this.grapCount = 0;
						for (int num63 = 0; num63 < 1000; num63++)
						{
							if (Main.projectile[num63].active && Main.projectile[num63].owner == i)
							{
								if (Main.projectile[num63].type == 13)
								{
									Main.projectile[num63].Kill();
								}
								if (Main.projectile[num63].type == 331)
								{
									Main.projectile[num63].Kill();
								}
								if (Main.projectile[num63].type == 315)
								{
									Main.projectile[num63].Kill();
								}
								if (Main.projectile[num63].type >= 230 && Main.projectile[num63].type <= 235)
								{
									Main.projectile[num63].Kill();
								}
							}
					...
					if (this.inventory[this.selectedItem].useAmmo > 0)
					{
						Item item2 = new Item();
						bool flag8 = false;
						for (int num64 = 54; num64 < 58; num64++)
						{
							if (this.inventory[num64].ammo == this.inventory[this.selectedItem].useAmmo && this.inventory[num64].stack > 0)
							{
								item2 = this.inventory[num64];
								flag7 = true;
								flag8 = true;
								break;
							}
						...
						if (!flag8)
						{
							...
							{
								if (this.inventory[num65].ammo == this.inventory[this.selectedItem].useAmmo && this.inventory[num65].stack > 0)
								{
									item2 = this.inventory[num65];
									flag7 = true;
									break;
								}
							}
						...
						if (flag7)
						{
							...
							{
								num62 = (float)((int)((double)num62 * 1.1));
								num60 *= 1.1f;
							}
							num60 += item2.shootSpeed;
							if (item2.ranged)
							{
								if (item2.damage > 0)
								{
									num61 += (int)((float)item2.damage * this.rangedDamage);
								}
							}
							else
							{
							...
							if (this.inventory[this.selectedItem].useAmmo == 1 && this.archery)
							{
								...
								num61 = (int)((double)((float)num61) * 1.2);
							}
							num62 += item2.knockBack;
							bool flag9 = false;
							...
							if (num59 == 85 && this.itemAnimation < this.itemAnimationMax - 6)
							{
								flag9 = true;
							}
							if ((num59 == 145 || num59 == 146 || num59 == 147 || num59 == 148 || num59 == 149) && this.itemAnimation < this.itemAnimationMax - 5)
							{
								flag9 = true;
							}
							if (!flag9)
					...
					if (this.inventory[this.selectedItem].type == 1254 && num59 == 14)
					{
						num59 = 242;
					}
					if (this.inventory[this.selectedItem].type == 1255 && num59 == 14)
					{
						num59 = 242;
					}
					if (this.inventory[this.selectedItem].type == 1265 && num59 == 14)
					{
						num59 = 242;
					}
					if (num59 == 73)
					{
						for (int num66 = 0; num66 < 1000; num66++)
						{
							...
							{
								if (Main.projectile[num66].type == 73)
								{
									num59 = 74;
								}
								if (num59 == 74 && Main.projectile[num66].type == 74)
								{
									flag7 = false;
								}
							}
					...
					if (flag7)
					{
						...
						{
							num62 += this.minionKB;
							num61 = (int)((float)num61 * this.minionDamage);
						}
						if (num59 == 228)
						{
							num62 = 0f;
						...
						{
							num62 *= 1f + (1f - this.stealth) * 0.5f;
						}
						if (num59 == 1 && this.inventory[this.selectedItem].type == 120)
						{
							num59 = 2;
						}
						...
						float num67 = (float)Main.mouseX + Main.screenPosition.X - vector.X;
						float num68 = (float)Main.mouseY + Main.screenPosition.Y - vector.Y;
						if (this.gravDir == -1f)
						{
							num68 = Main.screenPosition.Y + (float)Main.screenHeight - (float)Main.mouseY - vector.Y;
						}
						...
						{
							num67 += (float)Main.rand.Next(-50, 51) * 0.03f / num69;
							num68 += (float)Main.rand.Next(-50, 51) * 0.03f / num69;
						}
						num67 *= num69;
						num68 *= num69;
						if (this.inventory[this.selectedItem].type == 757)
						{
							num61 = (int)((float)num61 * 1.25f);
						}
						if (num59 == 250)
						{
							for (int num71 = 0; num71 < 1000; num71++)
							{
								if (Main.projectile[num71].active && Main.projectile[num71].owner == this.whoAmi && (Main.projectile[num71].type == 250 || Main.projectile[num71].type == 251))
								{
						...
						{
							this.itemRotation = (float)Math.Atan2((double)(num68 * (float)this.direction), (double)(num67 * (float)this.direction));
							NetMessage.SendData(13, -1, -1, "", this.whoAmi, 0f, 0f, 0f, 0);
						...
						if (num59 == 76)
						{
							...
							num70 /= (float)(Main.screenHeight / 2);
							if (num70 > 1f)
							{
								num70 = 1f;
							}
							float num72 = num67 + (float)Main.rand.Next(-40, 41) * 0.01f;
							float num73 = num68 + (float)Main.rand.Next(-40, 41) * 0.01f;
							num72 *= num70 + 0.25f;
							num73 *= num70 + 0.25f;
							int num74 = Projectile.NewProjectile(vector.X, vector.Y, num72, num73, num59, num61, num62, i, 0f, 0f);
							Main.projectile[num74].ai[1] = 1f;
							num70 = num70 * 2f - 1f;
							if (num70 < -1f)
							{
								num70 = -1f;
							...
							Main.projectile[num74].ai[0] = num70;
							NetMessage.SendData(27, -1, -1, "", num74, 0f, 0f, 0f, 0);
						}
						else if (this.inventory[this.selectedItem].type == 98 || this.inventory[this.selectedItem].type == 533)
						{
							float speedX = num67 + (float)Main.rand.Next(-40, 41) * 0.01f;
							float speedY = num68 + (float)Main.rand.Next(-40, 41) * 0.01f;
							Projectile.NewProjectile(vector.X, vector.Y, speedX, speedY, num59, num61, num62, i, 0f, 0f);
						}
						else if (this.inventory[this.selectedItem].type == 2270)
						{
							float num75 = num67 + (float)Main.rand.Next(-40, 41) * 0.05f;
							float num76 = num68 + (float)Main.rand.Next(-40, 41) * 0.05f;
							if (Main.rand.Next(3) == 0)
							{
								num75 *= 1f + (float)Main.rand.Next(-30, 31) * 0.02f;
								num76 *= 1f + (float)Main.rand.Next(-30, 31) * 0.02f;
							}
							Projectile.NewProjectile(vector.X, vector.Y, num75, num76, num59, num61, num62, i, 0f, 0f);
						}
						else if (this.inventory[this.selectedItem].type == 1930)
						{
							int num77 = 2 + Main.rand.Next(3);
							for (int num78 = 0; num78 < num77; num78++)
							{
								float num79 = num67;
								float num80 = num68;
								float num81 = 0.025f * (float)num78;
								num79 += (float)Main.rand.Next(-35, 36) * num81;
								num80 += (float)Main.rand.Next(-35, 36) * num81;
								num69 = (float)Math.Sqrt((double)(num79 * num79 + num80 * num80));
								num69 = num60 / num69;
								num79 *= num69;
								num80 *= num69;
								float x = vector.X + num67 * (float)(num77 - num78) * 1.75f;
								float y = vector.Y + num68 * (float)(num77 - num78) * 1.75f;
								Projectile.NewProjectile(x, y, num79, num80, num59, num61, num62, i, (float)Main.rand.Next(0, 10 * (num78 + 1)), 0f);
							}
						}
						else if (this.inventory[this.selectedItem].type == 1931)
						{
							...
							for (int num83 = 0; num83 < num82; num83++)
							{
								...
								vector.Y -= (float)(100 * num83);
								num67 = (float)Main.mouseX + Main.screenPosition.X - vector.X;
								num68 = (float)Main.mouseY + Main.screenPosition.Y - vector.Y;
								if (num68 < 0f)
								{
									num68 *= -1f;
								}
								...
								num67 *= num69;
								num68 *= num69;
								float speedX2 = num67 + (float)Main.rand.Next(-40, 41) * 0.02f;
								float speedY2 = num68 + (float)Main.rand.Next(-40, 41) * 0.02f;
								Projectile.NewProjectile(vector.X, vector.Y, speedX2, speedY2, num59, num61, num62, i, 0f, (float)Main.rand.Next(5));
							}
						}
						else if (this.inventory[this.selectedItem].type == 2624)
						{
							float num84 = 0.314159274f;
							int num85 = 5;
							Vector2 vector2 = new Vector2(num67, num68);
							vector2.Normalize();
							vector2 *= 40f;
							for (int num86 = 0; num86 < num85; num86++)
							{
								float num87 = (float)num86 - ((float)num85 - 1f) / 2f;
								Vector2 vector3 = vector2.Rotate((double)(num84 * num87), default(Vector2));
								int num88 = Projectile.NewProjectile(vector.X + vector3.X, vector.Y + vector3.Y, num67, num68, num59, num61, num62, i, 0f, 0f);
								Main.projectile[num88].noDropItem = true;
							}
						}
						else if (this.inventory[this.selectedItem].type == 1929)
						{
							float speedX3 = num67 + (float)Main.rand.Next(-40, 41) * 0.03f;
							float speedY3 = num68 + (float)Main.rand.Next(-40, 41) * 0.03f;
							Projectile.NewProjectile(vector.X, vector.Y, speedX3, speedY3, num59, num61, num62, i, 0f, 0f);
						}
						else if (this.inventory[this.selectedItem].type == 1553)
						{
							float speedX4 = num67 + (float)Main.rand.Next(-40, 41) * 0.005f;
							float speedY4 = num68 + (float)Main.rand.Next(-40, 41) * 0.005f;
							Projectile.NewProjectile(vector.X, vector.Y, speedX4, speedY4, num59, num61, num62, i, 0f, 0f);
						}
						else if (this.inventory[this.selectedItem].type == 518)
						{
							float num89 = num67;
							float num90 = num68;
							num89 += (float)Main.rand.Next(-40, 41) * 0.04f;
							num90 += (float)Main.rand.Next(-40, 41) * 0.04f;
							Projectile.NewProjectile(vector.X, vector.Y, num89, num90, num59, num61, num62, i, 0f, 0f);
						}
						else if (this.inventory[this.selectedItem].type == 1265)
						{
							float num91 = num67;
							float num92 = num68;
							num91 += (float)Main.rand.Next(-30, 31) * 0.03f;
							num92 += (float)Main.rand.Next(-30, 31) * 0.03f;
							Projectile.NewProjectile(vector.X, vector.Y, num91, num92, num59, num61, num62, i, 0f, 0f);
						}
						else if (this.inventory[this.selectedItem].type == 534)
						{
							for (int num93 = 0; num93 < 4; num93++)
							{
								...
								Projectile.NewProjectile(vector.X, vector.Y, num94, num95, num59, num61, num62, i, 0f, 0f);
							}
						}
						else if (this.inventory[this.selectedItem].type == 2188)
						{
							...
							for (int num97 = 0; num97 < num96; num97++)
							{
								...
								num69 = (float)Math.Sqrt((double)(num98 * num98 + num99 * num99));
								num69 = num60 / num69;
								num98 *= num69;
								num99 *= num69;
								float x2 = vector.X;
								float y2 = vector.Y;
								Projectile.NewProjectile(x2, y2, num98, num99, num59, num61, num62, i, 0f, 0f);
							}
						}
						else if (this.inventory[this.selectedItem].type == 1308)
						{
							...
							for (int num102 = 0; num102 < num101; num102++)
							{
								...
								num69 = (float)Math.Sqrt((double)(num103 * num103 + num104 * num104));
								num69 = num60 / num69;
								num103 *= num69;
								num104 *= num69;
								float x3 = vector.X;
								float y3 = vector.Y;
								Projectile.NewProjectile(x3, y3, num103, num104, num59, num61, num62, i, 0f, 0f);
							}
						}
						else if (this.inventory[this.selectedItem].type == 1258)
						{
							float num106 = num67;
							float num107 = num68;
							num106 += (float)Main.rand.Next(-40, 41) * 0.01f;
							num107 += (float)Main.rand.Next(-40, 41) * 0.01f;
							vector.X += (float)Main.rand.Next(-40, 41) * 0.05f;
							vector.Y += (float)Main.rand.Next(-45, 36) * 0.05f;
							Projectile.NewProjectile(vector.X, vector.Y, num106, num107, num59, num61, num62, i, 0f, 0f);
						}
						else if (this.inventory[this.selectedItem].type == 964)
						{
							for (int num108 = 0; num108 < 3; num108++)
							{
								...
								num110 += (float)Main.rand.Next(-35, 36) * 0.04f;
								Projectile.NewProjectile(vector.X, vector.Y, num109, num110, num59, num61, num62, i, 0f, 0f);
							}
						}
						else if (this.inventory[this.selectedItem].type == 1569)
						{
							...
							for (int num112 = 0; num112 < num111; num112++)
							{
								float num113 = num67;
								float num114 = num68;
								float num115 = 0.05f * (float)num112;
								num113 += (float)Main.rand.Next(-35, 36) * num115;
								num114 += (float)Main.rand.Next(-35, 36) * num115;
								num69 = (float)Math.Sqrt((double)(num113 * num113 + num114 * num114));
								num69 = num60 / num69;
								num113 *= num69;
								num114 *= num69;
								float x4 = vector.X;
								float y4 = vector.Y;
								Projectile.NewProjectile(x4, y4, num113, num114, num59, num61, num62, i, 0f, 0f);
							}
						}
						else if (this.inventory[this.selectedItem].type == 1572 || this.inventory[this.selectedItem].type == 2366)
						{
							...
							{
								if (Main.projectile[num117].owner == this.whoAmi && Main.projectile[num117].type == num116)
								{
									Main.projectile[num117].Kill();
								}
							}
							int num118 = (int)((float)Main.mouseX + Main.screenPosition.X) / 16;
							int num119 = (int)((float)Main.mouseY + Main.screenPosition.Y) / 16;
							if (this.gravDir == -1f)
							{
								num119 = (int)(Main.screenPosition.Y + (float)Main.screenHeight - (float)Main.mouseY) / 16;
							}
							while (num119 < Main.maxTilesY - 10 && Main.tile[num118, num119] != null && !WorldGen.SolidTile(num118, num119) && Main.tile[num118 - 1, num119] != null && !WorldGen.SolidTile(num118 - 1, num119) && Main.tile[num118 + 1, num119] != null && !WorldGen.SolidTile(num118 + 1, num119))
							{
								num119++;
							}
							num119--;
							Projectile.NewProjectile((float)Main.mouseX + Main.screenPosition.X, (float)(num119 * 16 - 24), 0f, 15f, num59, num61, num62, i, 0f, 0f);
						}
						else if (this.inventory[this.selectedItem].type == 1244 || this.inventory[this.selectedItem].type == 1256)
						{
							int num120 = Projectile.NewProjectile(vector.X, vector.Y, num67, num68, num59, num61, num62, i, 0f, 0f);
							Main.projectile[num120].ai[0] = (float)Main.mouseX + Main.screenPosition.X;
							Main.projectile[num120].ai[1] = (float)Main.mouseY + Main.screenPosition.Y;
						}
						else if (this.inventory[this.selectedItem].type == 1229)
						{
							int num121 = Main.rand.Next(2, 4);
							if (Main.rand.Next(5) == 0)
							{
								num121++;
							}
							for (int num122 = 0; num122 < num121; num122++)
							{
								...
								if (num122 > 0)
								{
									num123 += (float)Main.rand.Next(-35, 36) * 0.04f;
									num124 += (float)Main.rand.Next(-35, 36) * 0.04f;
								}
								if (num122 > 1)
								{
									num123 += (float)Main.rand.Next(-35, 36) * 0.04f;
								...
								int num125 = Projectile.NewProjectile(vector.X, vector.Y, num123, num124, num59, num61, num62, i, 0f, 0f);
						...
						else if (this.inventory[this.selectedItem].type == 1121 || this.inventory[this.selectedItem].type == 1155)
						{
							...
							for (int num127 = 0; num127 < num126; num127++)
							{
								float num128 = num67;
								float num129 = num68;
								num128 += (float)Main.rand.Next(-35, 36) * 0.02f;
								num129 += (float)Main.rand.Next(-35, 36) * 0.02f;
								Projectile.NewProjectile(vector.X, vector.Y, num128, num129, num59, num61, num62, i, 0f, 0f);
							}
						}
						else if (this.inventory[this.selectedItem].type == 1801)
						{
							int num130 = Main.rand.Next(1, 4);
							for (int num131 = 0; num131 < num130; num131++)
							{
								float num132 = num67;
								float num133 = num68;
								num132 += (float)Main.rand.Next(-35, 36) * 0.05f;
								num133 += (float)Main.rand.Next(-35, 36) * 0.05f;
								Projectile.NewProjectile(vector.X, vector.Y, num132, num133, num59, num61, num62, i, 0f, 0f);
							}
						}
						else if (this.inventory[this.selectedItem].type == 679)
						{
							for (int num134 = 0; num134 < 6; num134++)
							{
								...
								num136 += (float)Main.rand.Next(-40, 41) * 0.05f;
								Projectile.NewProjectile(vector.X, vector.Y, num135, num136, num59, num61, num62, i, 0f, 0f);
							}
						}
						else if (this.inventory[this.selectedItem].type == 2623)
						{
							for (int num137 = 0; num137 < 3; num137++)
							{
								...
								Projectile.NewProjectile(vector.X, vector.Y, num138, num139, num59, num61, num62, i, 0f, 0f);
							}
						}
						else if (this.inventory[this.selectedItem].type == 434)
						{
							...
							Projectile.NewProjectile(vector.X, vector.Y, num140, num141, num59, num61, num62, i, 0f, 0f);
						}
						else if (this.inventory[this.selectedItem].type == 1157)
						{
							num59 = Main.rand.Next(191, 195);
							num67 = 0f;
							num68 = 0f;
							vector.X = (float)Main.mouseX + Main.screenPosition.X;
							vector.Y = (float)Main.mouseY + Main.screenPosition.Y;
							int num142 = Projectile.NewProjectile(vector.X, vector.Y, num67, num68, num59, num61, num62, i, 0f, 0f);
							Main.projectile[num142].localAI[0] = 30f;
						}
						else if (this.inventory[this.selectedItem].type == 1802)
						{
							...
							vector.X = (float)Main.mouseX + Main.screenPosition.X;
							vector.Y = (float)Main.mouseY + Main.screenPosition.Y;
							Projectile.NewProjectile(vector.X, vector.Y, num67, num68, num59, num61, num62, i, 0f, 0f);
						}
						...
						else if (this.inventory[this.selectedItem].type == 2535)
						{
							...
							vector.X = (float)Main.mouseX + Main.screenPosition.X;
							vector.Y = (float)Main.mouseY + Main.screenPosition.Y;
							Vector2 spinningpoint = new Vector2(num67, num68);
							spinningpoint = spinningpoint.Rotate(1.5707963705062866, default(Vector2));
							Projectile.NewProjectile(vector.X + spinningpoint.X, vector.Y + spinningpoint.Y, spinningpoint.X, spinningpoint.Y, num59, num61, num62, i, 0f, 0f);
							spinningpoint = spinningpoint.Rotate(-3.1415927410125732, default(Vector2));
							Projectile.NewProjectile(vector.X + spinningpoint.X, vector.Y + spinningpoint.Y, spinningpoint.X, spinningpoint.Y, num59 + 1, num61, num62, i, 0f, 0f);
						}
						else if (this.inventory[this.selectedItem].type == 2551)
						{
							...
							vector.X = (float)Main.mouseX + Main.screenPosition.X;
							vector.Y = (float)Main.mouseY + Main.screenPosition.Y;
							Projectile.NewProjectile(vector.X, vector.Y, num67, num68, num59 + Main.rand.Next(3), num61, num62, i, 0f, 0f);
						}
						...
						else if (this.inventory[this.selectedItem].shoot > 0 && (Main.projPet[this.inventory[this.selectedItem].shoot] || this.inventory[this.selectedItem].shoot == 72 || this.inventory[this.selectedItem].shoot == 18) && !this.inventory[this.selectedItem].summon)
						{
							...
							{
								if (Main.projectile[num143].active && Main.projectile[num143].owner == this.whoAmi)
								{
									if (this.inventory[this.selectedItem].shoot == 72)
									{
										if (Main.projectile[num143].type == 72 || Main.projectile[num143].type == 86 || Main.projectile[num143].type == 87)
										{
											Main.projectile[num143].Kill();
										}
									}
									else if (this.inventory[this.selectedItem].shoot == Main.projectile[num143].type)
									{
										Main.projectile[num143].Kill();
									}
								}
						...
						{
							int num144 = Projectile.NewProjectile(vector.X, vector.Y, num67, num68, num59, num61, num62, i, 0f, 0f);
							if (this.inventory[this.selectedItem].type == 726)
							{
								Main.projectile[num144].magic = true;
							}
							if (this.inventory[this.selectedItem].type == 724 || this.inventory[this.selectedItem].type == 676)
							{
								Main.projectile[num144].melee = true;
							}
							if (num59 == 80)
							{
								Main.projectile[num144].ai[0] = (float)Player.tileTargetX;
								Main.projectile[num144].ai[1] = (float)Player.tileTargetY;
							}
						}
					}
					else if (this.inventory[this.selectedItem].useStyle == 5)
				...
				if (this.whoAmi == Main.myPlayer && (this.inventory[this.selectedItem].type == 509 || this.inventory[this.selectedItem].type == 510 || this.inventory[this.selectedItem].type == 849 || this.inventory[this.selectedItem].type == 850 || this.inventory[this.selectedItem].type == 851) && this.position.X / 16f - (float)Player.tileRangeX - (float)this.inventory[this.selectedItem].tileBoost - (float)this.blockRange <= (float)Player.tileTargetX && (this.position.X + (float)this.width) / 16f + (float)Player.tileRangeX + (float)this.inventory[this.selectedItem].tileBoost - 1f + (float)this.blockRange >= (float)Player.tileTargetX && this.position.Y / 16f - (float)Player.tileRangeY - (float)this.inventory[this.selectedItem].tileBoost - (float)this.blockRange <= (float)Player.tileTargetY && (this.position.Y + (float)this.height) / 16f + (float)Player.tileRangeY + (float)this.inventory[this.selectedItem].tileBoost - 2f + (float)this.blockRange >= (float)Player.tileTargetY)
				{
					...
					if (this.itemAnimation > 0 && this.itemTime == 0 && this.controlUseItem)
					{
						...
						if (this.inventory[this.selectedItem].type == 509)
						{
							...
							{
								if (this.inventory[num146].stack > 0 && this.inventory[num146].type == 530)
								{
									num145 = num146;
									break;
								}
							}
							if (num145 >= 0 && WorldGen.PlaceWire(i2, j2))
							{
								this.inventory[num145].stack--;
								if (this.inventory[num145].stack <= 0)
								{
									this.inventory[num145].SetDefaults(0, false);
								}
								this.itemTime = this.inventory[this.selectedItem].useTime;
						...
						else if (this.inventory[this.selectedItem].type == 850)
						{
							...
							{
								if (this.inventory[num148].stack > 0 && this.inventory[num148].type == 530)
								{
									num147 = num148;
									break;
								}
							}
							if (num147 >= 0 && WorldGen.PlaceWire2(i2, j2))
							{
								this.inventory[num147].stack--;
								if (this.inventory[num147].stack <= 0)
								{
									this.inventory[num147].SetDefaults(0, false);
								}
								this.itemTime = this.inventory[this.selectedItem].useTime;
						...
						if (this.inventory[this.selectedItem].type == 851)
						{
							...
							{
								if (this.inventory[num150].stack > 0 && this.inventory[num150].type == 530)
								{
									num149 = num150;
									break;
								}
							}
							if (num149 >= 0 && WorldGen.PlaceWire3(i2, j2))
							{
								this.inventory[num149].stack--;
								if (this.inventory[num149].stack <= 0)
								{
									this.inventory[num149].SetDefaults(0, false);
								}
								this.itemTime = this.inventory[this.selectedItem].useTime;
				...
				if (this.itemAnimation > 0 && this.itemTime == 0 && (this.inventory[this.selectedItem].type == 507 || this.inventory[this.selectedItem].type == 508))
				{
					...
					float num151 = (float)Main.mouseX + Main.screenPosition.X - vector4.X;
					float num152 = (float)Main.mouseY + Main.screenPosition.Y - vector4.Y;
					float num153 = (float)Math.Sqrt((double)(num151 * num151 + num152 * num152));
					num153 /= (float)(Main.screenHeight / 2);
					if (num153 > 1f)
					{
						num153 = 1f;
					}
					...
					NetMessage.SendData(58, -1, -1, "", this.whoAmi, num153, 0f, 0f, 0);
				}
				if (((this.inventory[this.selectedItem].type >= 205 && this.inventory[this.selectedItem].type <= 207) || this.inventory[this.selectedItem].type == 1128) && this.position.X / 16f - (float)Player.tileRangeX - (float)this.inventory[this.selectedItem].tileBoost <= (float)Player.tileTargetX && (this.position.X + (float)this.width) / 16f + (float)Player.tileRangeX + (float)this.inventory[this.selectedItem].tileBoost - 1f >= (float)Player.tileTargetX && this.position.Y / 16f - (float)Player.tileRangeY - (float)this.inventory[this.selectedItem].tileBoost <= (float)Player.tileTargetY && (this.position.Y + (float)this.height) / 16f + (float)Player.tileRangeY + (float)this.inventory[this.selectedItem].tileBoost - 2f >= (float)Player.tileTargetY)
				{
					...
					if (this.itemTime == 0 && this.itemAnimation > 0 && this.controlUseItem)
					{
						...
						{
							int num154 = (int)Main.tile[Player.tileTargetX, Player.tileTargetY].liquidType();
							int num155 = 0;
							for (int num156 = Player.tileTargetX - 1; num156 <= Player.tileTargetX + 1; num156++)
							{
								for (int num157 = Player.tileTargetY - 1; num157 <= Player.tileTargetY + 1; num157++)
								{
									if ((int)Main.tile[num156, num157].liquidType() == num154)
									{
										num155 += (int)Main.tile[num156, num157].liquid;
									}
								}
							}
							if (Main.tile[Player.tileTargetX, Player.tileTargetY].liquid > 0 && num155 > 100)
							{
								...
								Main.PlaySound(19, (int)this.position.X, (int)this.position.Y, 1);
								this.itemTime = this.inventory[this.selectedItem].useTime;
								int num158 = (int)Main.tile[Player.tileTargetX, Player.tileTargetY].liquid;
								...
								for (int num159 = Player.tileTargetX - 1; num159 <= Player.tileTargetX + 1; num159++)
								{
									...
									{
										if (num158 < 256 && (int)Main.tile[num159, num160].liquidType() == num154)
										{
											int num161 = (int)Main.tile[num159, num160].liquid;
											if (num161 + num158 > 255)
											{
												num161 = 255 - num158;
											}
											num158 += num161;
											Tile expr_8483 = Main.tile[num159, num160];
											expr_8483.liquid -= (byte)num161;
											Main.tile[num159, num160].liquidType(liquidType);
											if (Main.tile[num159, num160].liquid == 0)
											{
												Main.tile[num159, num160].lava(false);
												Main.tile[num159, num160].honey(false);
											}
											WorldGen.SquareTileFrame(num159, num160, false);
											if (Main.netMode == 1)
											{
												NetMessage.sendWater(num159, num160);
											}
											else
											{
												Liquid.AddWater(num159, num160);
											}
										}
									}
								}
				...
				if ((this.inventory[this.selectedItem].pick > 0 || this.inventory[this.selectedItem].axe > 0 || this.inventory[this.selectedItem].hammer > 0) && this.position.X / 16f - (float)Player.tileRangeX - (float)this.inventory[this.selectedItem].tileBoost <= (float)Player.tileTargetX && (this.position.X + (float)this.width) / 16f + (float)Player.tileRangeX + (float)this.inventory[this.selectedItem].tileBoost - 1f >= (float)Player.tileTargetX && this.position.Y / 16f - (float)Player.tileRangeY - (float)this.inventory[this.selectedItem].tileBoost <= (float)Player.tileTargetY && (this.position.Y + (float)this.height) / 16f + (float)Player.tileRangeY + (float)this.inventory[this.selectedItem].tileBoost - 2f >= (float)Player.tileTargetY)
				{
					...
					if (Main.tile[Player.tileTargetX, Player.tileTargetY].active())
					{
						...
						if (this.toolTime == 0 && this.itemAnimation > 0 && this.controlUseItem)
						{
							...
							if (Main.tileHammer[(int)Main.tile[Player.tileTargetX, Player.tileTargetY].type])
							{
								...
								{
									num162 += this.inventory[this.selectedItem].hammer;
									...
									if (this.hitTile.AddDamage(tileId, num162, true) >= 100)
									{
							...
							else if (Main.tileAxe[(int)Main.tile[Player.tileTargetX, Player.tileTargetY].type])
							{
								...
								{
									num162 += this.inventory[this.selectedItem].axe * 3;
								}
								else
								{
									num162 += this.inventory[this.selectedItem].axe;
								}
							...
							else if (this.inventory[this.selectedItem].pick > 0)
							{
								...
								{
									num162 += this.inventory[this.selectedItem].pick / 3;
								}
								...
								{
									num162 += this.inventory[this.selectedItem].pick / 5;
								}
								else
								{
									num162 += this.inventory[this.selectedItem].pick;
								}
								...
								if (this.hitTile.AddDamage(tileId, num162, false) >= 100 && (Main.tile[Player.tileTargetX, Player.tileTargetY].type == 2 || Main.tile[Player.tileTargetX, Player.tileTargetY].type == 23 || Main.tile[Player.tileTargetX, Player.tileTargetY].type == 60 || Main.tile[Player.tileTargetX, Player.tileTargetY].type == 70 || Main.tile[Player.tileTargetX, Player.tileTargetY].type == 109 || Main.tile[Player.tileTargetX, Player.tileTargetY].type == 71 || Main.tile[Player.tileTargetX, Player.tileTargetY].type == 199 || Main.tileMoss[(int)Main.tile[Player.tileTargetX, Player.tileTargetY].type]))
								{
									num162 = 0;
								}
								...
								if (Main.tile[Player.tileTargetX, Player.tileTargetY].type == 334)
								{
									...
									int num163 = (int)Main.tile[Player.tileTargetX, Player.tileTargetY].frameX;
									bool flag11 = num163 >= 5000;
									bool flag12 = false;
									if (!flag11)
									{
										int num164 = num163 / 18;
										num164 %= 3;
										Player.tileTargetX -= num164;
									...
									if (flag11)
									{
										num163 = (int)Main.tile[Player.tileTargetX, Player.tileTargetY].frameX;
										int num165 = 0;
										while (num163 >= 5000)
										{
											num163 -= 5000;
								...
								if (this.hitTile.AddDamage(tileId, num162, true) >= 100)
								{
									...
									{
										int num166 = Player.tileTargetY;
										WorldGen.KillTile(Player.tileTargetX, num166, false, false, false);
										if (Main.netMode == 1)
										{
											NetMessage.SendData(17, -1, -1, "", 0, (float)Player.tileTargetX, (float)num166, 0f, 0);
										}
									}
								}
								else
							...
							if (this.inventory[this.selectedItem].hammer > 0 && Main.tile[Player.tileTargetX, Player.tileTargetY].active() && ((Main.tileSolid[(int)Main.tile[Player.tileTargetX, Player.tileTargetY].type] && Main.tile[Player.tileTargetX, Player.tileTargetY].type != 10) || Main.tile[Player.tileTargetX, Player.tileTargetY].type == 314) && this.poundRelease)
							{
								flag10 = false;
								this.itemTime = this.inventory[this.selectedItem].useTime;
								num162 += (int)((double)this.inventory[this.selectedItem].hammer * 1.25);
								num162 = 100;
								...
								if (this.hitTile.AddDamage(tileId, num162, true) >= 100)
								{
									...
									if (this.poundRelease)
									{
										...
										if (Main.tile[num167, num168].type == 19)
										{
											if (Main.tile[num167, num168].halfBrick())
											{
												WorldGen.PoundTile(num167, num168);
												if (Main.netMode == 1)
												{
											...
											else
											{
												int num169 = 1;
												int slope = 2;
												if (Main.tile[num167 + 1, num168 - 1].type == 19 || Main.tile[num167 - 1, num168 + 1].type == 19 || (WorldGen.SolidTile(num167 + 1, num168) && !WorldGen.SolidTile(num167 - 1, num168)))
												{
													num169 = 2;
													slope = 1;
												}
												if (Main.tile[num167, num168].slope() == 0)
												{
													WorldGen.SlopeTile(num167, num168, num169);
													int num170 = (int)Main.tile[num167, num168].slope();
													if (Main.netMode == 1)
													{
														NetMessage.SendData(17, -1, -1, "", 14, (float)Player.tileTargetX, (float)Player.tileTargetY, (float)num170, 0);
													}
												}
												else if ((int)Main.tile[num167, num168].slope() == num169)
												{
													WorldGen.SlopeTile(num167, num168, slope);
													int num171 = (int)Main.tile[num167, num168].slope();
													if (Main.netMode == 1)
													{
														NetMessage.SendData(17, -1, -1, "", 14, (float)Player.tileTargetX, (float)Player.tileTargetY, (float)num171, 0);
													}
												}
												else
												{
													WorldGen.SlopeTile(num167, num168, 0);
													int num172 = (int)Main.tile[num167, num168].slope();
													if (Main.netMode == 1)
													{
														NetMessage.SendData(17, -1, -1, "", 14, (float)Player.tileTargetX, (float)Player.tileTargetY, (float)num172, 0);
													}
													WorldGen.PoundTile(num167, num168);
													if (Main.netMode == 1)
													{
										...
										else if (Main.tile[num167, num168].type == 314)
										{
											if (Minecart.FrameTrack(num167, num168, true, false) && Main.netMode == 1)
											{
												NetMessage.SendData(17, -1, -1, "", 15, (float)Player.tileTargetX, (float)Player.tileTargetY, 1f, 0);
											}
										}
										else if ((Main.tile[num167, num168].halfBrick() || Main.tile[num167, num168].slope() != 0) && !Main.tileSolidTop[(int)Main.tile[Player.tileTargetX, Player.tileTargetY].type])
										{
											int num173 = 1;
											int num174 = 1;
											int num175 = 2;
											if ((WorldGen.SolidTile(num167 + 1, num168) || Main.tile[num167 + 1, num168].slope() == 1 || Main.tile[num167 + 1, num168].slope() == 3) && !WorldGen.SolidTile(num167 - 1, num168))
											{
												num174 = 2;
												num175 = 1;
											}
											if (WorldGen.SolidTile(num167, num168 - 1) && !WorldGen.SolidTile(num167, num168 + 1))
											{
												num173 = -1;
											}
											if (num173 == 1)
											{
												if (Main.tile[num167, num168].slope() == 0)
												{
													WorldGen.SlopeTile(num167, num168, num174);
												}
												else if ((int)Main.tile[num167, num168].slope() == num174)
												{
													WorldGen.SlopeTile(num167, num168, num175);
												}
												else if ((int)Main.tile[num167, num168].slope() == num175)
												{
													WorldGen.SlopeTile(num167, num168, num174 + 2);
												}
												else if ((int)Main.tile[num167, num168].slope() == num174 + 2)
												{
													WorldGen.SlopeTile(num167, num168, num175 + 2);
												}
												else
												{
													WorldGen.SlopeTile(num167, num168, 0);
											...
											else if (Main.tile[num167, num168].slope() == 0)
											{
												WorldGen.SlopeTile(num167, num168, num174 + 2);
											}
											else if ((int)Main.tile[num167, num168].slope() == num174 + 2)
											...
											else if ((int)Main.tile[num167, num168].slope() == num175 + 2)
											{
												WorldGen.SlopeTile(num167, num168, num174);
											}
											else if ((int)Main.tile[num167, num168].slope() == num174)
											...
											int num176 = (int)Main.tile[num167, num168].slope();
											if (Main.netMode == 1)
											{
												NetMessage.SendData(17, -1, -1, "", 14, (float)Player.tileTargetX, (float)Player.tileTargetY, (float)num176, 0);
											}
										}
										else
										{
					...
					bool flag13 = true;
					if (Main.tile[num177, num178].wall > 0)
					{
						if (!Main.wallHouse[(int)Main.tile[num177, num178].wall])
						{
							for (int num179 = num177 - 1; num179 < num177 + 2; num179++)
							{
								for (int num180 = num178 - 1; num180 < num178 + 2; num180++)
								{
									if (Main.tile[num179, num180].wall != Main.tile[num177, num178].wall)
									{
										flag13 = false;
										break;
									}
					...
					if (flag13 && !Main.tile[num177, num178].active())
					{
						int num181 = -1;
						...
						for (int num183 = Player.tileTargetX + num181; num183 <= Player.tileTargetX + num181 + 1; num183++)
						{
							for (int num184 = Player.tileTargetY + num182; num184 <= Player.tileTargetY + num182 + 1; num184++)
							{
								if (flag13)
								{
									num177 = num183;
									...
									if (Main.tile[num177, num178].wall > 0)
									{
										if (!Main.wallHouse[(int)Main.tile[num177, num178].wall])
										{
											for (int num185 = num177 - 1; num185 < num177 + 2; num185++)
											{
												for (int num186 = num178 - 1; num186 < num178 + 2; num186++)
												{
													if (Main.tile[num185, num186].wall != Main.tile[num177, num178].wall)
													{
														flag13 = false;
														break;
													}
					...
					if (flag10 && Main.tile[num177, num178].wall > 0 && (!Main.tile[num177, num178].active() || num177 != Player.tileTargetX || num178 != Player.tileTargetY || (!Main.tileHammer[(int)Main.tile[num177, num178].type] && !this.poundRelease)) && this.toolTime == 0 && this.itemAnimation > 0 && this.controlUseItem && this.inventory[this.selectedItem].hammer > 0)
					{
						bool flag14 = true;
						if (!Main.wallHouse[(int)Main.tile[num177, num178].wall])
						{
							flag14 = false;
							for (int num187 = num177 - 1; num187 < num177 + 2; num187++)
							{
								for (int num188 = num178 - 1; num188 < num178 + 2; num188++)
								{
									if (Main.tile[num187, num188].wall == 0 || Main.wallHouse[(int)Main.tile[num187, num188].wall])
									{
										flag14 = true;
										break;
									}
						...
						if (flag14)
						{
							int tileId = this.hitTile.HitObject(num177, num178, 2);
							num162 += (int)((float)this.inventory[this.selectedItem].hammer * 1.5f);
							if (this.hitTile.AddDamage(tileId, num162, true) >= 100)
							{
								this.hitTile.Clear(tileId);
								WorldGen.KillWall(num177, num178, false);
								if (Main.netMode == 1)
								{
									NetMessage.SendData(17, -1, -1, "", 2, (float)num177, (float)num178, 0f, 0);
								}
							}
							else
							{
								WorldGen.KillWall(num177, num178, true);
								if (Main.netMode == 1)
								{
									NetMessage.SendData(17, -1, -1, "", 2, (float)num177, (float)num178, 1f, 0);
								}
							}
							if (num162 != 0)
							{
				...
				if (Main.myPlayer == this.whoAmi && this.inventory[this.selectedItem].type == 1326 && this.itemAnimation > 0 && this.itemTime == 0)
				{
					...
					{
						int num189 = (int)(newPos.X / 16f);
						int num190 = (int)(newPos.Y / 16f);
						if ((Main.tile[num189, num190].wall != 87 || (double)num190 <= Main.worldSurface || NPC.downedPlantBoss) && !Collision.SolidCollision(newPos, this.width, this.height))
						{
