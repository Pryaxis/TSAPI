	...
	public class Player
	{
		...
		public void ItemCheck(int i)
		{
			...
			if (this.inventory[this.selectedItem].type == 50 && this.itemAnimation > 0)
			{
				if (Main.rand.Next(2) == 0)
				{
					Microsoft.Xna.Framework.Vector2 arg_6943_0 = this.position;
				...
				else
				{
					if (this.itemTime == this.inventory[this.selectedItem].useTime / 2)
					{
						...
						{
							Microsoft.Xna.Framework.Vector2 arg_69DC_0 = this.position;
						...
						{
							Microsoft.Xna.Framework.Vector2 arg_6A8B_0 = this.position;
