...
namespace Terraria
{
    public class NetMessage
    {
            ...
            lock (buffer[num])
            {
                if (!NetHooks.OnSendData(ref msgType, ref remoteClient, ref ignoreClient, ref text, ref number, ref number2, ref number3, ref number4, ref number5))
                {
                    ...
                    switch (msgType)
                    {
                        ...
                        case 2:
                            {
                                ...
                                Buffer.BlockCopy(bytes6, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes4, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes5, 0, buffer[num].writeBuffer, 5, bytes5.Length);
                                if (Main.dedServ)
                                {
                                    Console.WriteLine(Netplay.serverSock[num].tcpClient.Client.RemoteEndPoint + " was booted: " + text);
                                }
                            }
                            break;
                        case 3:
                            {
                                ...
                                Buffer.BlockCopy(bytes9, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes7, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes8, 0, buffer[num].writeBuffer, 5, bytes8.Length);
                            }
                            break;
                        case 4:
                            {
                                ...
                                var b = (byte) number;
                                var b2 = (byte) Main.player[b].hair;
                                byte b3 = 0;
                                if (Main.player[b].male)
                                {
                                    b3 = 1;
                                }
                                ...
                                Buffer.BlockCopy(bytes10, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[5] = b;
                                num3++;
                                buffer[num].writeBuffer[6] = b2;
                                num3++;
                                buffer[num].writeBuffer[7] = b3;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].hairColor.R;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].hairColor.G;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].hairColor.B;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].skinColor.R;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].skinColor.G;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].skinColor.B;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].eyeColor.R;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].eyeColor.G;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].eyeColor.B;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].shirtColor.R;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].shirtColor.G;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].shirtColor.B;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].underShirtColor.R;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].underShirtColor.G;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].underShirtColor.B;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].pantsColor.R;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].pantsColor.G;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].pantsColor.B;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].shoeColor.R;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].shoeColor.G;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].shoeColor.B;
                                num3++;
                                buffer[num].writeBuffer[num3] = Main.player[b].difficulty;
                                num3++;
                        ...
                        case 5:
                            {
                                ...
                                Buffer.BlockCopy(bytes15, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes13, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[5] = b4;
                                num3++;
                                buffer[num].writeBuffer[6] = b5;
                                num3++;
                                buffer[num].writeBuffer[7] = b6;
                                num3++;
                                buffer[num].writeBuffer[8] = b7;
                                num3++;
                        ...
                        case 6:
                            {
                                ...
                                Buffer.BlockCopy(bytes17, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes16, 0, buffer[num].writeBuffer, 4, 1);
                            }
                            break;
                        case 7:
                            {
                                ...
                                Buffer.BlockCopy(bytes18, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes19, 0, buffer[num].writeBuffer, 5, bytes19.Length);
                                num3 += bytes19.Length;
                                ...
                                num3++;
                                Buffer.BlockCopy(bytes20, 0, buffer[num].writeBuffer, num3, bytes20.Length);
                                num3 += bytes20.Length;
                                Buffer.BlockCopy(bytes21, 0, buffer[num].writeBuffer, num3, bytes21.Length);
                                num3 += bytes21.Length;
                                Buffer.BlockCopy(bytes22, 0, buffer[num].writeBuffer, num3, bytes22.Length);
                                num3 += bytes22.Length;
                                ...
                                num3 += bytes24.Length;
                                Buffer.BlockCopy(bytes25, 0, buffer[num].writeBuffer, num3, bytes25.Length);
                                num3 += bytes25.Length;
                                Buffer.BlockCopy(bytes26, 0, buffer[num].writeBuffer, num3, bytes26.Length);
                                num3 += bytes26.Length;
                        ...
                        case 8:
                            {
                                ...
                                Buffer.BlockCopy(bytes32, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes29, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes30, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                Buffer.BlockCopy(bytes31, 0, buffer[num].writeBuffer, num3, 4);
                            }
                            break;
                        case 9:
                            {
                                ...
                                Buffer.BlockCopy(bytes36, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes33, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes34, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                Buffer.BlockCopy(bytes35, 0, buffer[num].writeBuffer, num3, bytes35.Length);
                            }
                            break;
                        case 10:
                            {
                                var num4 = (short) number;
                                var num5 = (int) number2;
                                var num6 = (int) number3;
                                byte[] bytes37 = BitConverter.GetBytes(msgType);
                                Buffer.BlockCopy(bytes37, 0, buffer[num].writeBuffer, 4, 1);
                                byte[] bytes38 = BitConverter.GetBytes(num4);
                                Buffer.BlockCopy(bytes38, 0, buffer[num].writeBuffer, num3, 2);
                                num3 += 2;
                                byte[] bytes39 = BitConverter.GetBytes(num5);
                                Buffer.BlockCopy(bytes39, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                byte[] bytes40 = BitConverter.GetBytes(num6);
                                Buffer.BlockCopy(bytes40, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                for (int i = num5; i < num5 + (int) num4; i++)
                                {
                                    ...
                                    if (Main.tile[i, num6].active)
                                    {
                                        buffer[num].writeBuffer[num3] = Main.tile[i, num6].type;
                                        num3++;
                                        if (Main.tileFrameImportant[Main.tile[i, num6].type])
                                        {
                                            Buffer.BlockCopy(bytes41, 0, buffer[num].writeBuffer, num3, 2);
                                            num3 += 2;
                                            Buffer.BlockCopy(bytes42, 0, buffer[num].writeBuffer, num3, 2);
                                            num3 += 2;
                                        }
                                    }
                                    if (wall > 0)
                                    {
                                        buffer[num].writeBuffer[num3] = wall;
                                        num3++;
                                    }
                                    if (Main.tile[i, num6].liquid > 0)
                                    {
                                        buffer[num].writeBuffer[num3] = Main.tile[i, num6].liquid;
                                        num3++;
                                        byte b13 = 0;
                                    ...
                                    short num7 = 1;
                                    while (i + num7 < num5 + num4 && Main.tile[i, num6].isTheSameAs(Main.tile[i + num7, num6]))
                                    {
                                        num7 += 1;
                                    }
                                    num7 -= 1;
                                    byte[] bytes43 = BitConverter.GetBytes(num7);
                                    Buffer.BlockCopy(bytes43, 0, buffer[num].writeBuffer, num3, 2);
                                    num3 += 2;
                                    i += num7;
                                }
                                byte[] bytes44 = BitConverter.GetBytes(num3 - 4);
                                Buffer.BlockCopy(bytes44, 0, buffer[num].writeBuffer, 0, 4);
                                num2 = num3;
                            }
                            break;
                        case 11:
                            {
                                ...
                                Buffer.BlockCopy(bytes50, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes45, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes46, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                Buffer.BlockCopy(bytes47, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                Buffer.BlockCopy(bytes48, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                Buffer.BlockCopy(bytes49, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                            }
                            break;
                        case 12:
                            {
                                ...
                                var b14 = (byte) number;
                                byte[] bytes52 = BitConverter.GetBytes(Main.player[b14].SpawnX);
                                byte[] bytes53 = BitConverter.GetBytes(Main.player[b14].SpawnY);
                                num2 += 1 + bytes52.Length + bytes53.Length;
                                byte[] bytes54 = BitConverter.GetBytes(num2 - 4);
                                Buffer.BlockCopy(bytes54, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes51, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[num3] = b14;
                                num3++;
                                Buffer.BlockCopy(bytes52, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                Buffer.BlockCopy(bytes53, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                            }
                            break;
                        case 13:
                            {
                                ...
                                var b15 = (byte) number;
                                byte b16 = 0;
                                if (Main.player[b15].controlUp)
                                {
                                    b16 += 1;
                                }
                                if (Main.player[b15].controlDown)
                                {
                                    b16 += 2;
                                }
                                if (Main.player[b15].controlLeft)
                                {
                                    b16 += 4;
                                }
                                if (Main.player[b15].controlRight)
                                {
                                    b16 += 8;
                                }
                                if (Main.player[b15].controlJump)
                                {
                                    b16 += 16;
                                }
                                if (Main.player[b15].controlUseItem)
                                {
                                    b16 += 32;
                                }
                                if (Main.player[b15].direction == 1)
                                {
                                    b16 += 64;
                                }
                                var b17 = (byte) Main.player[b15].selectedItem;
                                ...
                                Buffer.BlockCopy(bytes60, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes55, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[5] = b15;
                                num3++;
                                buffer[num].writeBuffer[6] = b16;
                                num3++;
                                buffer[num].writeBuffer[7] = b17;
                                num3++;
                                Buffer.BlockCopy(bytes56, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                Buffer.BlockCopy(bytes57, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                Buffer.BlockCopy(bytes58, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                Buffer.BlockCopy(bytes59, 0, buffer[num].writeBuffer, num3, 4);
                            }
                            break;
                        case 14:
                            {
                                ...
                                var b18 = (byte) number;
                                var b19 = (byte) number2;
                                num2 += 2;
                                byte[] bytes62 = BitConverter.GetBytes(num2 - 4);
                                Buffer.BlockCopy(bytes62, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes61, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[5] = b18;
                                buffer[num].writeBuffer[6] = b19;
                            }
                            break;
                        case 15:
                            {
                        ...
                        case 16:
                            {
                                ...
                                var b20 = (byte) number;
                                byte[] bytes66 = BitConverter.GetBytes((short) Main.player[b20].statLife);
                                byte[] bytes67 = BitConverter.GetBytes((short) Main.player[b20].statLifeMax);
                                ...
                                buffer[num].writeBuffer[5] = b20;
                                num3++;
                                Buffer.BlockCopy(bytes66, 0, buffer[num].writeBuffer, num3, 2);
                                num3 += 2;
                                Buffer.BlockCopy(bytes67, 0, buffer[num].writeBuffer, num3, 2);
                            }
                            break;
                        case 17:
                            {
                                ...
                                var b22 = (byte) number4;
                                num2 += 1 + bytes70.Length + bytes71.Length + 1 + 1;
                                byte[] bytes72 = BitConverter.GetBytes(num2 - 4);
                                Buffer.BlockCopy(bytes72, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes69, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[num3] = b21;
                                num3++;
                                Buffer.BlockCopy(bytes70, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                Buffer.BlockCopy(bytes71, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                        ...
                        case 18:
                            {
                                ...
                                Buffer.BlockCopy(bytes77, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes73, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[num3] = b23;
                                num3++;
                                Buffer.BlockCopy(bytes74, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                Buffer.BlockCopy(bytes75, 0, buffer[num].writeBuffer, num3, 2);
                                num3 += 2;
                                Buffer.BlockCopy(bytes76, 0, buffer[num].writeBuffer, num3, 2);
                                num3 += 2;
                            }
                            break;
                        case 19:
                            {
                                ...
                                Buffer.BlockCopy(bytes81, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes78, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[num3] = b24;
                                num3++;
                                Buffer.BlockCopy(bytes79, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                Buffer.BlockCopy(bytes80, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                        ...
                        case 20:
                            {
                                var num8 = (short) number;
                                var num9 = (int) number2;
                                var num10 = (int) number3;
                                byte[] bytes82 = BitConverter.GetBytes(msgType);
                                Buffer.BlockCopy(bytes82, 0, buffer[num].writeBuffer, 4, 1);
                                byte[] bytes83 = BitConverter.GetBytes(num8);
                                Buffer.BlockCopy(bytes83, 0, buffer[num].writeBuffer, num3, 2);
                                num3 += 2;
                                byte[] bytes84 = BitConverter.GetBytes(num9);
                                Buffer.BlockCopy(bytes84, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                byte[] bytes85 = BitConverter.GetBytes(num10);
                                Buffer.BlockCopy(bytes85, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                for (int j = num9; j < num9 + (int) num8; j++)
                                {
                                    for (int k = num10; k < num10 + (int) num8; k++)
                                    {
                                        ...
                                        if (Main.tile[j, k].active)
                                        {
                                            buffer[num].writeBuffer[num3] = Main.tile[j, k].type;
                                            num3++;
                                            if (Main.tileFrameImportant[Main.tile[j, k].type])
                                            {
                                                Buffer.BlockCopy(bytes86, 0, buffer[num].writeBuffer, num3, 2);
                                                num3 += 2;
                                                Buffer.BlockCopy(bytes87, 0, buffer[num].writeBuffer, num3, 2);
                                                num3 += 2;
                                            }
                                        }
                                        if (wall2 > 0)
                                        {
                                            buffer[num].writeBuffer[num3] = wall2;
                                            num3++;
                                        }
                                        if (Main.tile[j, k].liquid > 0 && Main.netMode == 2)
                                        {
                                            buffer[num].writeBuffer[num3] = Main.tile[j, k].liquid;
                                            num3++;
                                            byte b27 = 0;
                        ...
                        case 21:
                            {
                                ...
                                var b28 = (byte) Main.item[number].stack;
                                ...
                                Buffer.BlockCopy(bytes96, 0, buffer[num].writeBuffer, 0, 4);
                                ...
                                num3 += 4;
                                Buffer.BlockCopy(bytes92, 0, buffer[num].writeBuffer, num3, bytes92.Length);
                                num3 += 4;
                                Buffer.BlockCopy(bytes93, 0, buffer[num].writeBuffer, num3, bytes93.Length);
                                num3 += 4;
                                Buffer.BlockCopy(bytes94, 0, buffer[num].writeBuffer, num3, bytes94.Length);
                                num3 += 4;
                                buffer[num].writeBuffer[num3] = b28;
                                num3++;
                                buffer[num].writeBuffer[num3] = prefix;
                                num3++;
                                Buffer.BlockCopy(bytes95, 0, buffer[num].writeBuffer, num3, bytes95.Length);
                            }
                            break;
                        case 22:
                            {
                                ...
                                var b29 = (byte) Main.item[number].owner;
                                num2 += bytes98.Length + 1;
                                byte[] bytes99 = BitConverter.GetBytes(num2 - 4);
                                Buffer.BlockCopy(bytes99, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes97, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes98, 0, buffer[num].writeBuffer, num3, bytes98.Length);
                                num3 += 2;
                                buffer[num].writeBuffer[num3] = b29;
                            }
                            break;
                        case 23:
                            {
                                ...
                                num3 += 4;
                                Buffer.BlockCopy(bytes103, 0, buffer[num].writeBuffer, num3, bytes103.Length);
                                num3 += 4;
                                Buffer.BlockCopy(bytes104, 0, buffer[num].writeBuffer, num3, bytes104.Length);
                                num3 += 4;
                                Buffer.BlockCopy(bytes105, 0, buffer[num].writeBuffer, num3, bytes105.Length);
                                num3 += 4;
                                Buffer.BlockCopy(bytes106, 0, buffer[num].writeBuffer, num3, bytes106.Length);
                                num3 += 2;
                                ...
                                num3++;
                                Buffer.BlockCopy(bytes107, 0, buffer[num].writeBuffer, num3, bytes107.Length);
                                num3 += 4;
                                for (int l = 0; l < NPC.maxAI; l++)
                                {
                                    byte[] bytes110 = BitConverter.GetBytes(Main.npc[number].ai[l]);
                                    Buffer.BlockCopy(bytes110, 0, buffer[num].writeBuffer, num3, bytes110.Length);
                                    num3 += 4;
                                }
                        ...
                        case 24:
                            {
                                ...
                                var b30 = (byte) number2;
                                num2 += bytes112.Length + 1;
                                byte[] bytes113 = BitConverter.GetBytes(num2 - 4);
                                Buffer.BlockCopy(bytes113, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes111, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes112, 0, buffer[num].writeBuffer, num3, bytes112.Length);
                                num3 += 2;
                                buffer[num].writeBuffer[num3] = b30;
                            }
                            break;
                        case 25:
                            {
                                ...
                                num3++;
                                Buffer.BlockCopy(bytes115, 0, buffer[num].writeBuffer, num3, bytes115.Length);
                            }
                            break;
                        case 26:
                            {
                        ...
                        case 27:
                            {
                                ...
                                Buffer.BlockCopy(bytes121, 0, buffer[num].writeBuffer, 4, 1);
                                ...
                                num3 += 4;
                                Buffer.BlockCopy(bytes126, 0, buffer[num].writeBuffer, num3, bytes126.Length);
                                num3 += 4;
                                Buffer.BlockCopy(bytes127, 0, buffer[num].writeBuffer, num3, bytes127.Length);
                                num3 += 4;
                                Buffer.BlockCopy(bytes128, 0, buffer[num].writeBuffer, num3, bytes128.Length);
                                num3 += 2;
                                buffer[num].writeBuffer[num3] = (byte) Main.projectile[number].owner;
                                num3++;
                                buffer[num].writeBuffer[num3] = (byte) Main.projectile[number].type;
                                num3++;
                        ...
                        case 28:
                            {
                                ...
                                var b39 = (byte) (number4 + 1f);
                                var b40 = (byte) number5;
                                ...
                                Buffer.BlockCopy(bytes132, 0, buffer[num].writeBuffer, num3, bytes132.Length);
                                num3 += 2;
                                Buffer.BlockCopy(bytes133, 0, buffer[num].writeBuffer, num3, bytes133.Length);
                                num3 += 2;
                                Buffer.BlockCopy(bytes134, 0, buffer[num].writeBuffer, num3, bytes134.Length);
                                num3 += 4;
                        ...
                        case 29:
                            {
                                ...
                                var b41 = (byte) number2;
                                num2 += bytes137.Length + 1;
                                byte[] bytes138 = BitConverter.GetBytes(num2 - 4);
                                Buffer.BlockCopy(bytes138, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes136, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes137, 0, buffer[num].writeBuffer, num3, bytes137.Length);
                                num3 += 2;
                                buffer[num].writeBuffer[num3] = b41;
                            }
                            break;
                        case 30:
                            {
                                ...
                                var b42 = (byte) number;
                                byte b43 = 0;
                                if (Main.player[b42].hostile)
                                {
                                    b43 = 1;
                                }
                                num2 += 2;
                                byte[] bytes140 = BitConverter.GetBytes(num2 - 4);
                                Buffer.BlockCopy(bytes140, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes139, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[num3] = b42;
                                num3++;
                        ...
                        case 31:
                            {
                                ...
                                Buffer.BlockCopy(bytes142, 0, buffer[num].writeBuffer, num3, bytes142.Length);
                                num3 += 4;
                                Buffer.BlockCopy(bytes143, 0, buffer[num].writeBuffer, num3, bytes143.Length);
                            }
                            break;
                        case 32:
                            {
                                ...
                                var b44 = (byte) number2;
                                var b45 = (byte) Main.chest[number].item[(int) number2].stack;
                                ...
                                Buffer.BlockCopy(bytes146, 0, buffer[num].writeBuffer, num3, bytes146.Length);
                                num3 += 2;
                                buffer[num].writeBuffer[num3] = b44;
                                num3++;
                                buffer[num].writeBuffer[num3] = b45;
                                num3++;
                                buffer[num].writeBuffer[num3] = prefix2;
                                num3++;
                                Buffer.BlockCopy(bytes147, 0, buffer[num].writeBuffer, num3, bytes147.Length);
                            }
                            break;
                        case 33:
                            {
                                ...
                                Buffer.BlockCopy(bytes153, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes149, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes150, 0, buffer[num].writeBuffer, num3, bytes150.Length);
                                num3 += 2;
                                Buffer.BlockCopy(bytes151, 0, buffer[num].writeBuffer, num3, bytes151.Length);
                                num3 += 4;
                                Buffer.BlockCopy(bytes152, 0, buffer[num].writeBuffer, num3, bytes152.Length);
                            }
                            break;
                        case 34:
                            {
                                ...
                                Buffer.BlockCopy(bytes157, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes154, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes155, 0, buffer[num].writeBuffer, num3, bytes155.Length);
                                num3 += 4;
                                Buffer.BlockCopy(bytes156, 0, buffer[num].writeBuffer, num3, bytes156.Length);
                            }
                            break;
                        case 35:
                            {
                                ...
                                Buffer.BlockCopy(bytes158, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[5] = b46;
                                num3++;
                                Buffer.BlockCopy(bytes159, 0, buffer[num].writeBuffer, num3, 2);
                            }
                            break;
                        case 36:
                            {
                                ...
                                var b47 = (byte) number;
                                byte b48 = 0;
                                if (Main.player[b47].zoneEvil)
                                {
                                    b48 = 1;
                                }
                                byte b49 = 0;
                                if (Main.player[b47].zoneMeteor)
                                {
                                    b49 = 1;
                                }
                                byte b50 = 0;
                                if (Main.player[b47].zoneDungeon)
                                {
                                    b50 = 1;
                                }
                                byte b51 = 0;
                                if (Main.player[b47].zoneJungle)
                                {
                                    b51 = 1;
                                }
                                byte b52 = 0;
                                if (Main.player[b47].zoneHoly)
                                {
                                    b52 = 1;
                                }
                                num2 += 6;
                                byte[] bytes162 = BitConverter.GetBytes(num2 - 4);
                                Buffer.BlockCopy(bytes162, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes161, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[num3] = b47;
                                num3++;
                                buffer[num].writeBuffer[num3] = b48;
                                num3++;
                                buffer[num].writeBuffer[num3] = b49;
                                num3++;
                                buffer[num].writeBuffer[num3] = b50;
                                num3++;
                        ...
                        case 37:
                            {
                                ...
                                Buffer.BlockCopy(bytes164, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes163, 0, buffer[num].writeBuffer, 4, 1);
                            }
                            break;
                        case 38:
                            {
                                ...
                                Buffer.BlockCopy(bytes167, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes165, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes166, 0, buffer[num].writeBuffer, num3, bytes166.Length);
                            }
                            break;
                        case 39:
                            {
                                ...
                                Buffer.BlockCopy(bytes168, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes169, 0, buffer[num].writeBuffer, num3, bytes169.Length);
                            }
                            break;
                        case 40:
                            {
                                ...
                                var b53 = (byte) number;
                                byte[] bytes172 = BitConverter.GetBytes((short) Main.player[b53].talkNPC);
                                ...
                                buffer[num].writeBuffer[num3] = b53;
                                num3++;
                                Buffer.BlockCopy(bytes172, 0, buffer[num].writeBuffer, num3, bytes172.Length);
                                num3 += 2;
                            }
                            break;
                        case 41:
                            {
                                ...
                                var b54 = (byte) number;
                                byte[] bytes175 = BitConverter.GetBytes(Main.player[b54].itemRotation);
                                byte[] bytes176 = BitConverter.GetBytes((short) Main.player[b54].itemAnimation);
                                ...
                                buffer[num].writeBuffer[num3] = b54;
                                num3++;
                        ...
                        case 42:
                            {
                                ...
                                var b55 = (byte) number;
                                byte[] bytes179 = BitConverter.GetBytes((short) Main.player[b55].statMana);
                                byte[] bytes180 = BitConverter.GetBytes((short) Main.player[b55].statManaMax);
                                num2 += 1 + bytes179.Length + bytes180.Length;
                                byte[] bytes181 = BitConverter.GetBytes(num2 - 4);
                                Buffer.BlockCopy(bytes181, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes178, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[5] = b55;
                                num3++;
                                Buffer.BlockCopy(bytes179, 0, buffer[num].writeBuffer, num3, 2);
                                num3 += 2;
                                Buffer.BlockCopy(bytes180, 0, buffer[num].writeBuffer, num3, 2);
                            }
                            break;
                        case 43:
                            {
                                ...
                                Buffer.BlockCopy(bytes184, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes182, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[5] = b56;
                                num3++;
                                Buffer.BlockCopy(bytes183, 0, buffer[num].writeBuffer, num3, 2);
                            }
                            break;
                        case 44:
                            {
                                ...
                                Buffer.BlockCopy(bytes188, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes185, 0, buffer[num].writeBuffer, 4, 1);
                        ...
                        case 45:
                            {
                                ...
                                var b60 = (byte) number;
                                var b61 = (byte) Main.player[b60].team;
                                num2 += 2;
                                byte[] bytes190 = BitConverter.GetBytes(num2 - 4);
                                Buffer.BlockCopy(bytes190, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes189, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[5] = b60;
                                num3++;
                        ...
                        case 46:
                            {
                                ...
                                Buffer.BlockCopy(bytes194, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes191, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes192, 0, buffer[num].writeBuffer, num3, bytes192.Length);
                                num3 += 4;
                                Buffer.BlockCopy(bytes193, 0, buffer[num].writeBuffer, num3, bytes193.Length);
                            }
                            break;
                        case 47:
                            {
                                ...
                                Buffer.BlockCopy(bytes200, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes195, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes196, 0, buffer[num].writeBuffer, num3, bytes196.Length);
                                num3 += bytes196.Length;
                                Buffer.BlockCopy(bytes197, 0, buffer[num].writeBuffer, num3, bytes197.Length);
                                num3 += bytes197.Length;
                                Buffer.BlockCopy(bytes198, 0, buffer[num].writeBuffer, num3, bytes198.Length);
                                num3 += bytes198.Length;
                                Buffer.BlockCopy(bytes199, 0, buffer[num].writeBuffer, num3, bytes199.Length);
                        ...
                        case 48:
                            {
                                ...
                                Buffer.BlockCopy(bytes204, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes201, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes202, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                Buffer.BlockCopy(bytes203, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                buffer[num].writeBuffer[num3] = liquid;
                                num3++;
                                buffer[num].writeBuffer[num3] = b62;
                                num3++;
                            }
                            break;
                        case 49:
                            {
                                ...
                                Buffer.BlockCopy(bytes206, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes205, 0, buffer[num].writeBuffer, 4, 1);
                            }
                            break;
                        case 50:
                            {
                                ...
                                Buffer.BlockCopy(bytes207, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[num3] = b63;
                                num3++;
                                for (int n = 0; n < 10; n++)
                                {
                                    buffer[num].writeBuffer[num3] = (byte) Main.player[b63].buffType[n];
                                    num3++;
                                }
                            }
                            break;
                        case 51:
                            {
                                ...
                                num2 += 2;
                                var b64 = (byte) number;
                                var b65 = (byte) number2;
                                byte[] bytes210 = BitConverter.GetBytes(num2 - 4);
                                Buffer.BlockCopy(bytes210, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes209, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[num3] = b64;
                                num3++;
                        ...
                        case 52:
                            {
                                ...
                                Buffer.BlockCopy(bytes214, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes211, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[num3] = b66;
                                num3++;
                                buffer[num].writeBuffer[num3] = b67;
                                num3++;
                                Buffer.BlockCopy(bytes212, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                                Buffer.BlockCopy(bytes213, 0, buffer[num].writeBuffer, num3, 4);
                                num3 += 4;
                            }
                            break;
                        case 53:
                            {
                                ...
                                Buffer.BlockCopy(bytes218, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes215, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes216, 0, buffer[num].writeBuffer, num3, bytes216.Length);
                                num3 += bytes216.Length;
                                buffer[num].writeBuffer[num3] = b68;
                                num3++;
                                Buffer.BlockCopy(bytes217, 0, buffer[num].writeBuffer, num3, bytes217.Length);
                        ...
                        case 54:
                            {
                                ...
                                Buffer.BlockCopy(bytes221, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes219, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes220, 0, buffer[num].writeBuffer, num3, bytes220.Length);
                                num3 += bytes220.Length;
                                for (int num11 = 0; num11 < 5; num11++)
                                {
                                    buffer[num].writeBuffer[num3] = (byte) Main.npc[((short) number)].buffType[num11];
                                    num3++;
                                    byte[] bytes222 = BitConverter.GetBytes(Main.npc[((short) number)].buffTime[num11]);
                                    Buffer.BlockCopy(bytes222, 0, buffer[num].writeBuffer, num3, bytes222.Length);
                        ...
                        case 55:
                            {
                                ...
                                var b69 = (byte) number;
                                var b70 = (byte) number2;
                                byte[] bytes224 = BitConverter.GetBytes((short) number3);
                                num2 += 2 + bytes224.Length;
                                byte[] bytes225 = BitConverter.GetBytes(num2 - 4);
                                Buffer.BlockCopy(bytes225, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes223, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[num3] = b69;
                                num3++;
                                buffer[num].writeBuffer[num3] = b70;
                                num3++;
                                Buffer.BlockCopy(bytes224, 0, buffer[num].writeBuffer, num3, bytes224.Length);
                        ...
                        case 56:
                            {
                                ...
                                Buffer.BlockCopy(bytes229, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes226, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes227, 0, buffer[num].writeBuffer, num3, bytes227.Length);
                                num3 += bytes227.Length;
                                Buffer.BlockCopy(bytes228, 0, buffer[num].writeBuffer, num3, bytes228.Length);
                            }
                            break;
                        case 57:
                            {
                                ...
                                Buffer.BlockCopy(bytes231, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes230, 0, buffer[num].writeBuffer, 4, 1);
                        ...
                        case 58:
                            {
                                ...
                                Buffer.BlockCopy(bytes234, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes232, 0, buffer[num].writeBuffer, 4, 1);
                                buffer[num].writeBuffer[num3] = b71;
                                num3++;
                                Buffer.BlockCopy(bytes233, 0, buffer[num].writeBuffer, num3, bytes233.Length);
                            }
                            break;
                        case 59:
                            {
                                ...
                                Buffer.BlockCopy(bytes238, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes235, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes236, 0, buffer[num].writeBuffer, num3, bytes236.Length);
                                num3 += 4;
                                Buffer.BlockCopy(bytes237, 0, buffer[num].writeBuffer, num3, bytes237.Length);
                            }
                            break;
                        case 60:
                            {
                                ...
                                var b72 = (byte) number4;
                                num2 += bytes240.Length + bytes241.Length + bytes242.Length + 1;
                                byte[] bytes243 = BitConverter.GetBytes(num2 - 4);
                                Buffer.BlockCopy(bytes243, 0, buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy(bytes239, 0, buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy(bytes240, 0, buffer[num].writeBuffer, num3, bytes240.Length);
                                num3 += 2;
                                Buffer.BlockCopy(bytes241, 0, buffer[num].writeBuffer, num3, bytes241.Length);
                                num3 += 2;
                                Buffer.BlockCopy(bytes242, 0, buffer[num].writeBuffer, num3, bytes242.Length);
                                num3 += 2;
                                buffer[num].writeBuffer[num3] = b72;
                                num3++;
                            }
                            break;
                    }
                    ...
                    if (Main.verboseNetplay)
                    {
                        ...
                        {
                            byte arg_4A42_0 = buffer[num].writeBuffer[num13];
                        }
                        goto IL_4A54;
                    }
                    goto IL_4A54;
                    ...
                    if (remoteClient == -1)
                    {
                        if (msgType == 20)
                        {
                            ...
                            {
                                if (num14 != ignoreClient && (buffer[num14].broadcast || (Netplay.serverSock[num14].state >= 3 && msgType == 10)) && Netplay.serverSock[num14].tcpClient.Connected && Netplay.serverSock[num14].SectionRange(number, (int) number2, (int) number3))
                                {
                                    try
                                    {
                                        ...
                                        Main.txMsgType[msgType]++;
                                        Main.txDataType[msgType] += num2;
                                        SendBytes(Netplay.serverSock[num14], buffer[num].writeBuffer, 0, num2, Netplay.serverSock[num14].ServerWriteCallBack, Netplay.serverSock[num14].networkStream);
                        ...
                        if (msgType == 28)
                        {
                            for (int num15 = 0; num15 < 256; num15++)
                            {
                                if (num15 != ignoreClient && (buffer[num15].broadcast || (Netplay.serverSock[num15].state >= 3 && msgType == 10)) && Netplay.serverSock[num15].tcpClient.Connected)
                                {
                                    ...
                                    {
                                        var rectangle = new Rectangle((int) Main.player[num15].position.X, (int) Main.player[num15].position.Y, Main.player[num15].width, Main.player[num15].height);
                                        var value2 = new Rectangle((int) Main.npc[number].position.X, (int) Main.npc[number].position.Y, Main.npc[number].width, Main.npc[number].height);
                                        value2.X -= 3000;
                                        value2.Y -= 3000;
                                        value2.Width += 6000;
                                        value2.Height += 6000;
                                    ...
                                    if (flag2)
                                    {
                                        try
                                        {
                                            ...
                                            Main.txMsgType[msgType]++;
                                            Main.txDataType[msgType] += num2;
                                            SendBytes(Netplay.serverSock[num15], buffer[num].writeBuffer, 0, num2, Netplay.serverSock[num15].ServerWriteCallBack, Netplay.serverSock[num15].networkStream);
                        ...
                        if (msgType == 13)
                        {
                            for (int num16 = 0; num16 < 256; num16++)
                            {
                                if (num16 != ignoreClient && (buffer[num16].broadcast || (Netplay.serverSock[num16].state >= 3 && msgType == 10)) && Netplay.serverSock[num16].tcpClient.Connected)
                                {
                                    ...
                                    {
                                        var rectangle2 = new Rectangle((int) Main.player[num16].position.X, (int) Main.player[num16].position.Y, Main.player[num16].width, Main.player[num16].height);
                                        var value3 = new Rectangle((int) Main.player[number].position.X, (int) Main.player[number].position.Y, Main.player[number].width, Main.player[number].height);
                                        value3.X -= 2500;
                                        value3.Y -= 2500;
                                        value3.Width += 5000;
                                        value3.Height += 5000;
                                    ...
                                    if (flag3)
                                    {
                                        try
                                        {
                                            ...
                                            Main.txMsgType[msgType]++;
                                            Main.txDataType[msgType] += num2;
                                            SendBytes(Netplay.serverSock[num16], buffer[num].writeBuffer, 0, num2, Netplay.serverSock[num16].ServerWriteCallBack, Netplay.serverSock[num16].networkStream);
                            ...
                            if (msgType == 27)
                            {
                                for (int num17 = 0; num17 < 256; num17++)
                                {
                                    if (num17 != ignoreClient && (buffer[num17].broadcast || (Netplay.serverSock[num17].state >= 3 && msgType == 10)) && Netplay.serverSock[num17].tcpClient.Connected)
                                    {
                                        ...
                                        {
                                            var rectangle3 = new Rectangle((int) Main.player[num17].position.X, (int) Main.player[num17].position.Y, Main.player[num17].width, Main.player[num17].height);
                                            var value4 = new Rectangle((int) Main.projectile[number].position.X, (int) Main.projectile[number].position.Y, Main.projectile[number].width, Main.projectile[number].height);
                                            value4.X -= 5000;
                                            value4.Y -= 5000;
                                            value4.Width += 10000;
                                            value4.Height += 10000;
                                        ...
                                        if (flag4)
                                        {
                                            try
                                            {
                                                ...
                                                Main.txMsgType[msgType]++;
                                                Main.txDataType[msgType] += num2;
                                                SendBytes(Netplay.serverSock[num17], buffer[num].writeBuffer, 0, num2, Netplay.serverSock[num17].ServerWriteCallBack, Netplay.serverSock[num17].networkStream);
                            ...
                            for (int num18 = 0; num18 < 256; num18++)
                            {
                                if (num18 != ignoreClient && (buffer[num18].broadcast || (Netplay.serverSock[num18].state >= 3 && msgType == 10)) && Netplay.serverSock[num18].tcpClient.Connected)
                                {
                                    try
                                    {
                                        ...
                                        Main.txMsgType[msgType]++;
                                        Main.txDataType[msgType] += num2;
                                        SendBytes(Netplay.serverSock[num18], buffer[num].writeBuffer, 0, num2, Netplay.serverSock[num18].ServerWriteCallBack, Netplay.serverSock[num18].networkStream);
                    ...
                    else
                    {
                        if (Netplay.serverSock[remoteClient].tcpClient.Connected)
                        {
                            try
                            {
                                ...
                                Main.txMsgType[msgType]++;
                                Main.txDataType[msgType] += num2;
                                SendBytes(Netplay.serverSock[remoteClient], buffer[num].writeBuffer, 0, num2, Netplay.serverSock[remoteClient].ServerWriteCallBack, Netplay.serverSock[remoteClient].networkStream);
        ...
        {
            int num = (size - 1)/2;
            SendData(20, whoAmi, -1, "", size, (tileX - num), (tileY - num), 0f, 0);
        }
        ...
        public static void SendSection(int whoAmi, int sectionX, int sectionY)
        {
            ...
            try
            {
                if (sectionX >= 0 && sectionY >= 0 && sectionX < Main.maxSectionsX && sectionY < Main.maxSectionsY)
                {
                    ...
                    {
                        SendData(10, whoAmi, -1, "", 200, num, i, 0f, 0);
                    }
                }
            }
            catch
        ...
        public static void greetPlayer(int plr)
        {
            ...
            if (Main.motd == "")
            {
                SendData(25, plr, -1, "Welcome to " + Main.worldName + "!", 255, 255f, 240f, 20f, 0);
            }
            else
            {
                SendData(25, plr, -1, Main.motd, 255, 255f, 240f, 20f, 0);
            }
            string text = "";
            for (int i = 0; i < 255; i++)
            {
            ...
            SendData(25, plr, -1, "Current players: " + text + ".", 255, 255f, 240f, 20f, 0);
        }
        ...
        public static void syncPlayers()
        {
            ...
            for (int i = 0; i < 255; i++)
            {
                ...
                if (Netplay.serverSock[i].state == 10)
                {
                    ...
                    SendData(14, -1, i, "", i, num, 0f, 0f, 0);
                    SendData(4, -1, i, Main.player[i].name, i, 0f, 0f, 0f, 0);
                    SendData(13, -1, i, "", i, 0f, 0f, 0f, 0);
                    SendData(16, -1, i, "", i, 0f, 0f, 0f, 0);
                    SendData(30, -1, i, "", i, 0f, 0f, 0f, 0);
                    SendData(45, -1, i, "", i, 0f, 0f, 0f, 0);
                    SendData(42, -1, i, "", i, 0f, 0f, 0f, 0);
                    SendData(50, -1, i, "", i, 0f, 0f, 0f, 0);
                    for (int k = 0; k < 49; k++)
                    {
                        SendData(5, -1, i, Main.player[i].inventory[k].name, i, k, Main.player[i].inventory[k].prefix, 0f, 0);
                    }
                    SendData(5, -1, i, Main.player[i].armor[0].name, i, 49f, Main.player[i].armor[0].prefix, 0f, 0);
                    SendData(5, -1, i, Main.player[i].armor[1].name, i, 50f, Main.player[i].armor[1].prefix, 0f, 0);
                    SendData(5, -1, i, Main.player[i].armor[2].name, i, 51f, Main.player[i].armor[2].prefix, 0f, 0);
                    SendData(5, -1, i, Main.player[i].armor[3].name, i, 52f, Main.player[i].armor[3].prefix, 0f, 0);
                    SendData(5, -1, i, Main.player[i].armor[4].name, i, 53f, Main.player[i].armor[4].prefix, 0f, 0);
                    SendData(5, -1, i, Main.player[i].armor[5].name, i, 54f, Main.player[i].armor[5].prefix, 0f, 0);
                    SendData(5, -1, i, Main.player[i].armor[6].name, i, 55f, Main.player[i].armor[6].prefix, 0f, 0);
                    SendData(5, -1, i, Main.player[i].armor[7].name, i, 56f, Main.player[i].armor[7].prefix, 0f, 0);
                    SendData(5, -1, i, Main.player[i].armor[8].name, i, 57f, Main.player[i].armor[8].prefix, 0f, 0);
                    SendData(5, -1, i, Main.player[i].armor[9].name, i, 58f, Main.player[i].armor[9].prefix, 0f, 0);
                    SendData(5, -1, i, Main.player[i].armor[10].name, i, 59f, Main.player[i].armor[10].prefix, 0f, 0);
                    if (!Netplay.serverSock[i].announced)
                    {
                        Netplay.serverSock[i].announced = true;
                        SendData(25, -1, i, Main.player[i].name + " has joined.", 255, 255f, 240f, 20f, 0);
                        if (Main.dedServ)
                        {
                ...
                else
                {
                    ...
                    if (Netplay.serverSock[i].announced)
                    {
                        ...
                        SendData(25, -1, i, Netplay.serverSock[i].oldName + " has left.", 255, 255f, 240f, 20f, 0);
                        if (Main.dedServ)
                        {
            ...
            for (int l = 0; l < 200; l++)
            {
                if (Main.npc[l].active && Main.npc[l].townNPC && NPC.TypeToNum(Main.npc[l].type) != -1)
                {
                    ...
                    SendData(60, -1, -1, "", l, Main.npc[l].homeTileX, Main.npc[l].homeTileY, num2, 0);
                }
            }
            if (Main.autoShutdown && !flag)
            {
