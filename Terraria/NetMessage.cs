    ...
    public class NetMessage
    {
        ...
        public static void SendData(int msgType, int remoteClient = -1, int ignoreClient = -1, string text = "", int number = 0, float number2 = 0f, float number3 = 0f, float number4 = 0f, int number5 = 0)
        {
...

            {
                ...
                if (!ServerApi.Hooks.InvokeNetSendData(ref msgType, ref remoteClient, ref ignoreClient, ref text, ref number, ref number2, ref number3, ref number4, ref number5))
                {
                    lock (NetMessage.buffer[num].writeBuffer)
                    {
                        ...
                        switch (msgType)
                        {
                            ...
                            case 2:
                                {
                                    ...
                                    {
                                        Console.WriteLine(
                                            Netplay.serverSock[num].tcpClient.Client.RemoteEndPoint.ToString() +
                                            " was booted: " + text);
                                    }
                                }
                                break;
                            ...
                            case 4:
                                {
                                    ...
                                    num3++;
                                    Buffer.BlockCopy(bytes11, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes11.Length);
                                }
                                break;
                            case 5:
                                {
                                    ...
                                    if (number2 < 49f)
                                    {
                                        ...
                                        bytes14 =
                                            BitConverter.GetBytes(
                                                (short) Main.player[number].inventory[(int) number2].netID);
                                    ...
                                    {
                                        if (Main.player[number].armor[(int) number2 - 48 - 1].name == "" ||
                                            Main.player[number].armor[(int) number2 - 48 - 1].stack == 0 ||
                                            Main.player[number].armor[(int) number2 - 48 - 1].type == 0)
                                        {
                                        ...
                                        bytes14 =
                                            BitConverter.GetBytes(
                                                (short) Main.player[number].armor[(int) number2 - 48 - 1].netID);
                                    ...
                                    num3++;
                                    Buffer.BlockCopy(bytes14, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes14.Length);
                                }
                                break;
                            case 6:
                            ...
                            case 7:
                                {
                                    ...
                                    num2 += bytes19.Length + 1 + 1 + 1 + bytes20.Length + bytes21.Length +
                                            bytes22.Length + bytes23.Length + bytes24.Length + bytes25.Length +
                                            bytes26.Length + 1 + bytes27.Length;
                                    ...
                                    num3++;
                                    Buffer.BlockCopy(bytes20, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes20.Length);
                                    num3 += bytes20.Length;
                                    Buffer.BlockCopy(bytes21, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes21.Length);
                                    num3 += bytes21.Length;
                                    Buffer.BlockCopy(bytes22, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes22.Length);
                                    num3 += bytes22.Length;
                                    Buffer.BlockCopy(bytes23, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes23.Length);
                                    num3 += bytes23.Length;
                                    Buffer.BlockCopy(bytes24, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes24.Length);
                                    num3 += bytes24.Length;
                                    Buffer.BlockCopy(bytes25, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes25.Length);
                                    num3 += bytes25.Length;
                                    Buffer.BlockCopy(bytes26, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes26.Length);
                                    num3 += bytes26.Length;
                                    NetMessage.buffer[num].writeBuffer[num3] = b11;
                                    num3++;
                                    Buffer.BlockCopy(bytes27, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes27.Length);
                                    num3 += bytes27.Length;
                                }
                                break;
                            ...
                            case 9:
                                {
                                    ...
                                    num3 += 4;
                                    Buffer.BlockCopy(bytes35, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes35.Length);
                                }
                                break;
                            case 10:
                                {
                                    ...
                                    for (int i = num5; i < num5 + (int) num4; i++)
                                    {
                                        ...
                                        short num7 = 1;
                                        while (i + (int) num7 < num5 + (int) num4 &&
                                               Main.tile[i, num6].isTheSameAs(Main.tile[i + (int) num7, num6]))
                                        {
                                            num7 += 1;
                                        }
                                        num7 -= 1;
                                    ...
                                    for (int j = num9; j < num9 + (int) num8; j++)
                                    {
                                        for (int k = num10; k < num10 + (int) num8; k++)
                                        {
                                            ...
                                            if (Main.tile[j, k].active)
                                            {
                                                ...
                                                {
                                                    Buffer.BlockCopy(bytes86, 0, NetMessage.buffer[num].writeBuffer,
                                                                     num3, 2);
                                                    num3 += 2;
                                                    Buffer.BlockCopy(bytes87, 0, NetMessage.buffer[num].writeBuffer,
                                                                     num3, 2);
                                                    num3 += 2;
                                                }
                                            }
                            ...
                            case 21:
                                {
                                    ...
                                    num2 += bytes90.Length + bytes91.Length + bytes92.Length + bytes93.Length +
                                            bytes94.Length + 1 + bytes95.Length + 1;
                                    ...
                                    Buffer.BlockCopy(bytes90, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes90.Length);
                                    num3 += 2;
                                    Buffer.BlockCopy(bytes91, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes91.Length);
                                    num3 += 4;
                                    Buffer.BlockCopy(bytes92, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes92.Length);
                                    num3 += 4;
                                    Buffer.BlockCopy(bytes93, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes93.Length);
                                    num3 += 4;
                                    Buffer.BlockCopy(bytes94, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes94.Length);
                                    num3 += 4;
                                    ...
                                    num3++;
                                    Buffer.BlockCopy(bytes95, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes95.Length);
                                }
                                break;
                            case 22:
                                {
                                    ...
                                    Buffer.BlockCopy(bytes98, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes98.Length);
                                    num3 += 2;
                            ...
                            case 23:
                                {
                                    ...
                                    num2 += bytes101.Length + bytes102.Length + bytes103.Length + bytes104.Length +
                                            bytes105.Length + bytes106.Length + bytes107.Length + NPC.maxAI*4 +
                                            bytes108.Length + 1 + 1;
                                    ...
                                    Buffer.BlockCopy(bytes101, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes101.Length);
                                    num3 += 2;
                                    Buffer.BlockCopy(bytes102, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes102.Length);
                                    num3 += 4;
                                    Buffer.BlockCopy(bytes103, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes103.Length);
                                    num3 += 4;
                                    Buffer.BlockCopy(bytes104, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes104.Length);
                                    num3 += 4;
                                    Buffer.BlockCopy(bytes105, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes105.Length);
                                    num3 += 4;
                                    Buffer.BlockCopy(bytes106, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes106.Length);
                                    num3 += 2;
                                    ...
                                    num3++;
                                    Buffer.BlockCopy(bytes107, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes107.Length);
                                    num3 += 4;
                                    for (int l = 0; l < NPC.maxAI; l++)
                                    {
                                        byte[] bytes110 = BitConverter.GetBytes(Main.npc[number].ai[l]);
                                        Buffer.BlockCopy(bytes110, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                         bytes110.Length);
                                        num3 += 4;
                                    }
                                    Buffer.BlockCopy(bytes108, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes108.Length);
                                }
                                break;
                            case 24:
                                {
                                    ...
                                    Buffer.BlockCopy(bytes112, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes112.Length);
                                    num3 += 2;
                            ...
                            case 25:
                                {
                                    ...
                                    num3++;
                                    Buffer.BlockCopy(bytes115, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes115.Length);
                                }
                                break;
                            case 26:
                                {
                                    ...
                                    num3++;
                                    Buffer.BlockCopy(bytes118, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes118.Length);
                                    num3 += 2;
                                    ...
                                    num3++;
                                    Buffer.BlockCopy(bytes119, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes119.Length);
                                }
                                break;
                            case 27:
                                {
                                    ...
                                    Buffer.BlockCopy(bytes122, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes122.Length);
                                    num3 += 2;
                                    Buffer.BlockCopy(bytes123, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes123.Length);
                                    num3 += 4;
                                    Buffer.BlockCopy(bytes124, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes124.Length);
                                    num3 += 4;
                                    Buffer.BlockCopy(bytes125, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes125.Length);
                                    num3 += 4;
                                    Buffer.BlockCopy(bytes126, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes126.Length);
                                    num3 += 4;
                                    Buffer.BlockCopy(bytes127, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes127.Length);
                                    num3 += 4;
                                    Buffer.BlockCopy(bytes128, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes128.Length);
                                    num3 += 2;
                                    ...
                                    for (int m = 0; m < Projectile.maxAI; m++)
                                    {
                                        ...
                                        Buffer.BlockCopy(bytes129, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                         bytes129.Length);
                                        num3 += 4;
                                    }
                                    num2 += num3;
                            ...
                            case 28:
                                {
                                    ...
                                    Buffer.BlockCopy(bytes132, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes132.Length);
                                    num3 += 2;
                                    Buffer.BlockCopy(bytes133, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes133.Length);
                                    num3 += 2;
                                    Buffer.BlockCopy(bytes134, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes134.Length);
                                    num3 += 4;
                            ...
                            case 29:
                                {
                                    ...
                                    Buffer.BlockCopy(bytes137, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes137.Length);
                                    num3 += 2;
                            ...
                            case 31:
                                {
                                    ...
                                    Buffer.BlockCopy(bytes142, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes142.Length);
                                    num3 += 4;
                                    Buffer.BlockCopy(bytes143, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes143.Length);
                                }
                                break;
                            case 32:
                                {
                                    ...
                                    Buffer.BlockCopy(bytes146, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes146.Length);
                                    num3 += 2;
                            ...
                            case 33:
                                {
                                    ...
                                    Buffer.BlockCopy(bytes150, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes150.Length);
                                    num3 += 2;
                                    Buffer.BlockCopy(bytes151, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes151.Length);
                                    num3 += 4;
                            ...
                            case 34:
                                {
                                    ...
                                    Buffer.BlockCopy(bytes155, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes155.Length);
                                    num3 += 4;
                            ...
                            case 39:
                                {
                                    ...
                                    Buffer.BlockCopy(bytes169, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes169.Length);
                                }
                                break;
                            case 40:
                                {
                                    ...
                                    num3++;
                                    Buffer.BlockCopy(bytes172, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes172.Length);
                                    num3 += 2;
                                }
                                break;
                            case 41:
                                {
                                    ...
                                    num3++;
                                    Buffer.BlockCopy(bytes175, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes175.Length);
                                    num3 += 4;
                                    Buffer.BlockCopy(bytes176, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes176.Length);
                                }
                                break;
                            case 42:
                            ...
                            case 46:
                                {
                                    ...
                                    Buffer.BlockCopy(bytes192, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes192.Length);
                                    num3 += 4;
                                    Buffer.BlockCopy(bytes193, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes193.Length);
                                }
                                break;
                            case 47:
                                {
                                    ...
                                    Buffer.BlockCopy(bytes196, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes196.Length);
                                    ...
                                    Buffer.BlockCopy(bytes199, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes199.Length);
                            ...
                            case 50:
                                {
                                    ...
                                    for (int n = 0; n < 10; n++)
                                    {
                                        NetMessage.buffer[num].writeBuffer[num3] =
                                            (byte) Main.player[(int) b63].buffType[n];
                                        num3++;
                                    }
                                }
                                break;
                            ...
                            case 53:
                                {
                                    ...
                                    Buffer.BlockCopy(bytes216, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes216.Length);
                                    num3 += bytes216.Length;
                                    NetMessage.buffer[num].writeBuffer[num3] = b68;
                                    num3++;
                                    Buffer.BlockCopy(bytes217, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes217.Length);
                            ...
                            case 54:
                                {
                                    ...
                                    Buffer.BlockCopy(bytes220, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes220.Length);
                                    num3 += bytes220.Length;
                                    for (int num11 = 0; num11 < 5; num11++)
                                    {
                                        NetMessage.buffer[num].writeBuffer[num3] =
                                            (byte) Main.npc[(int) ((short) number)].buffType[num11];
                                        num3++;
                                        byte[] bytes222 =
                                            BitConverter.GetBytes(Main.npc[(int) ((short) number)].buffTime[num11]);
                                        Buffer.BlockCopy(bytes222, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                         bytes222.Length);
                            ...
                            case 55:
                                {
                                    ...
                                    num3++;
                                    Buffer.BlockCopy(bytes224, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes224.Length);
                            ...
                            case 56:
                                {
                                    ...
                                    Buffer.BlockCopy(bytes227, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes227.Length);
                                    num3 += bytes227.Length;
                                    Buffer.BlockCopy(bytes228, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes228.Length);
                                }
                                break;
                            case 57:
                            ...
                            case 58:
                                {
                                    ...
                                    num3++;
                                    Buffer.BlockCopy(bytes233, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes233.Length);
                                }
                                break;
                            case 59:
                                {
                                    ...
                                    Buffer.BlockCopy(bytes236, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes236.Length);
                                    num3 += 4;
                                    Buffer.BlockCopy(bytes237, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes237.Length);
                                }
                                break;
                            case 60:
                                {
                                    ...
                                    Buffer.BlockCopy(bytes240, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes240.Length);
                                    num3 += 2;
                                    Buffer.BlockCopy(bytes241, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes241.Length);
                                    num3 += 2;
                                    Buffer.BlockCopy(bytes242, 0, NetMessage.buffer[num].writeBuffer, num3,
                                                     bytes242.Length);
                                    num3 += 2;
                            ...
                            case 61:
                                ...
                                Buffer.BlockCopy((Array) BitConverter.GetBytes(num2 - 4), 0,
                                                 (Array) NetMessage.buffer[num].writeBuffer, 0, 4);
                                Buffer.BlockCopy((Array) local_338, 0, (Array) NetMessage.buffer[num].writeBuffer, 4, 1);
                                Buffer.BlockCopy((Array) local_339, 0, (Array) NetMessage.buffer[num].writeBuffer, num3,
                                                 local_339.Length);
                                int local_2_171 = num3 + local_339.Length;
                                Buffer.BlockCopy((Array) local_340, 0, (Array) NetMessage.buffer[num].writeBuffer,
                                                 local_2_171, local_340.Length);
                                break;
                        }
                        if (Main.netMode != 1)
                        {
                        ...
                        if (Netplay.clientSock.tcpClient.Connected)
                        {
                            try
                            {
                                ...
                                Netplay.clientSock.networkStream.BeginWrite(NetMessage.buffer[num].writeBuffer, 0, num2,
                                                                            new AsyncCallback(
                                                                                Netplay.clientSock.ClientWriteCallBack),
                                                                            Netplay.clientSock.networkStream);
                                goto IL_4A0B;
                            }
                            catch
                            {
                        ...
                        if (remoteClient == -1)
                        {
                            if (msgType == 20)
                            {
                                ...
                                {
                                    if (num14 != ignoreClient &&
                                        (NetMessage.buffer[num14].broadcast ||
                                         (Netplay.serverSock[num14].state >= 3 && msgType == 10)) &&
                                        Netplay.serverSock[num14].tcpClient.Connected &&
                                        Netplay.serverSock[num14].SectionRange(number, (int) number2, (int) number3))
                                    {
                                        try
                                        {
                                            ...
                                            NetMessage.SendBytes(Netplay.serverSock[num14],
                                                                 NetMessage.buffer[num].writeBuffer, 0, num2,
                                                                 new AsyncCallback(
                                                                     Netplay.serverSock[num14].ServerWriteCallBack),
                                                                 Netplay.serverSock[num14].networkStream);
                                        }
                                        catch
                                        {
                                        }
                            ...
                            if (msgType == 28)
                            {
                                ...
                                {
                                    if (num15 != ignoreClient &&
                                        (NetMessage.buffer[num15].broadcast ||
                                         (Netplay.serverSock[num15].state >= 3 && msgType == 10)) &&
                                        Netplay.serverSock[num15].tcpClient.Connected)
                                    {
                                        bool flag2 = false;
                                        ...
                                        {
                                            Rectangle rectangle = new Rectangle((int) Main.player[num15].position.X,
                                                                                (int) Main.player[num15].position.Y,
                                                                                Main.player[num15].width,
                                                                                Main.player[num15].height);
                                            Rectangle value2 = new Rectangle((int) Main.npc[number].position.X,
                                                                             (int) Main.npc[number].position.Y,
                                                                             Main.npc[number].width,
                                                                             Main.npc[number].height);
                                            value2.X -= 3000;
                                            value2.Y -= 3000;
                                            value2.Width += 6000;
                                            value2.Height += 6000;
                                        ...
                                        if (flag2)
                                        {
                                            try
                                            {
                                                ...
                                                Main.txMsgType[msgType]++;
                                                Main.txDataType[msgType] += num2;
                                                NetMessage.SendBytes(Netplay.serverSock[num15],
                                                                     NetMessage.buffer[num].writeBuffer, 0, num2,
                                                                     new AsyncCallback(
                                                                         Netplay.serverSock[num15].ServerWriteCallBack),
                                                                     Netplay.serverSock[num15].networkStream);
                                            }
                                            catch
                                            {
                                            }
                            ...
                            if (msgType == 13)
                            {
                                for (int num16 = 0; num16 < 256; num16++)
                                {
                                    if (num16 != ignoreClient &&
                                        (NetMessage.buffer[num16].broadcast ||
                                         (Netplay.serverSock[num16].state >= 3 && msgType == 10)) &&
                                        Netplay.serverSock[num16].tcpClient.Connected)
                                    {
                                        bool flag3 = false;
                                        if (Main.player[number].netSkip > 0)
                                        {
                                            Rectangle rectangle2 = new Rectangle((int) Main.player[num16].position.X,
                                                                                 (int) Main.player[num16].position.Y,
                                                                                 Main.player[num16].width,
                                                                                 Main.player[num16].height);
                                            Rectangle value3 = new Rectangle((int) Main.player[number].position.X,
                                                                             (int) Main.player[number].position.Y,
                                                                             Main.player[number].width,
                                                                             Main.player[number].height);
                                            value3.X -= 2500;
                                            value3.Y -= 2500;
                                            value3.Width += 5000;
                                            value3.Height += 5000;
                                        ...
                                        if (flag3)
                                        {
                                            try
                                            {
                                                ...
                                                Main.txMsgType[msgType]++;
                                                Main.txDataType[msgType] += num2;
                                                NetMessage.SendBytes(Netplay.serverSock[num16],
                                                                     NetMessage.buffer[num].writeBuffer, 0, num2,
                                                                     new AsyncCallback(
                                                                         Netplay.serverSock[num16].ServerWriteCallBack),
                                                                     Netplay.serverSock[num16].networkStream);
                                            }
                                            catch
                                            {
                                            }
                            ...
                            else
                            {
                                if (msgType == 27)
                                {
                                    for (int num17 = 0; num17 < 256; num17++)
                                    {
                                        if (num17 != ignoreClient &&
                                            (NetMessage.buffer[num17].broadcast ||
                                             (Netplay.serverSock[num17].state >= 3 && msgType == 10)) &&
                                            Netplay.serverSock[num17].tcpClient.Connected)
                                        {
                                            ...
                                            else
                                            {
                                                Rectangle rectangle3 = new Rectangle(
                                                    (int) Main.player[num17].position.X,
                                                    (int) Main.player[num17].position.Y, Main.player[num17].width,
                                                    Main.player[num17].height);
                                                Rectangle value4 =
                                                    new Rectangle((int) Main.projectile[number].position.X,
                                                                  (int) Main.projectile[number].position.Y,
                                                                  Main.projectile[number].width,
                                                                  Main.projectile[number].height);
                                                value4.X -= 5000;
                                                value4.Y -= 5000;
                                                value4.Width += 10000;
                                                value4.Height += 10000;
                                            ...
                                            if (flag4)
                                            {
                                                try
                                                {
                                                    ...
                                                    Main.txMsgType[msgType]++;
                                                    Main.txDataType[msgType] += num2;
                                                    NetMessage.SendBytes(Netplay.serverSock[num17],
                                                                         NetMessage.buffer[num].writeBuffer, 0, num2,
                                                                         new AsyncCallback(
                                                                             Netplay.serverSock[num17].
                                                                                 ServerWriteCallBack),
                                                                         Netplay.serverSock[num17].networkStream);
                                                }
                                                catch
                                                {
                                                }
                                ...
                                for (int num18 = 0; num18 < 256; num18++)
                                {
                                    if (num18 != ignoreClient &&
                                        (NetMessage.buffer[num18].broadcast ||
                                         (Netplay.serverSock[num18].state >= 3 && msgType == 10)) &&
                                        Netplay.serverSock[num18].tcpClient.Connected)
                                    {
                                        try
                                        {
                                            ...
                                            Main.txMsgType[msgType]++;
                                            Main.txDataType[msgType] += num2;
                                            NetMessage.SendBytes(Netplay.serverSock[num18],
                                                                 NetMessage.buffer[num].writeBuffer, 0, num2,
                                                                 new AsyncCallback(
                                                                     Netplay.serverSock[num18].ServerWriteCallBack),
                                                                 Netplay.serverSock[num18].networkStream);
                                        }
                                        catch
                                        {
                                        }
                        ...
                        else
                        {
                            if (Netplay.serverSock[remoteClient].tcpClient.Connected)
                            {
                                try
                                {
                                    ...
                                    Main.txMsgType[msgType]++;
                                    Main.txDataType[msgType] += num2;
                                    NetMessage.SendBytes(Netplay.serverSock[remoteClient],
                                                         NetMessage.buffer[num].writeBuffer, 0, num2,
                                                         new AsyncCallback(
                                                             Netplay.serverSock[remoteClient].ServerWriteCallBack),
