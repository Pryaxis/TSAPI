				...
				case 26:
					{
						...
						Main.player[num59].HurtOld(num61, num60, flag6, true, str3, item7, cooldownCounter);
				...
				case 44:
					{
						...
						Main.player[num114].KillMeOld((double)num116, num115, num117 == 1, str6);
				...
				case 118:
					{
						...
						if (Main.netMode == 2)  //anti cheat
							plr = whoAmI;

						PlayerDeathReason reason = PlayerDeathReason.FromReader(reader);

						int dmg = reader.ReadInt16();
						int dir = reader.ReadByte() - 1;
						BitsByte pack = reader.ReadByte();
						bool pvp = pack[0];

						Main.player[plr].KillMe(reason, dmg, dir, pvp);
						if (Main.netMode == 2)
							NetMessage.SendPlayerDeath(plr, reason, dmg, dir, pvp, -1, whoAmI);
					}
					break;
				default:
					{
