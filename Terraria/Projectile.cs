	...
	public class Projectile : Entity
	{
						...
						if ((base.Center - Main.player[Main.myPlayer].Center).Length() < (float)(Main.screenWidth + num170 * 16))
						{
							...
							for (int num173 = num171 - num170; num173 <= num171 + num170; num173++)
							{
								for (int num174 = num172 - num170; num174 <= num172 + num170; num174++)
								{
									if (Main.rand.Next(4) == 0)
									{
										Vector2 vector20 = new Vector2((float)(num171 - num173), (float)(num172 - num174));
										if (vector20.Length() < (float)num170 && num173 > 0 && num173 < Main.maxTilesX - 1 && num174 > 0 && num174 < Main.maxTilesY - 1 && Main.tile[num173, num174] != null && Main.tile[num173, num174].active())
										{
											bool flag3 = false;
							...
							else
							{
								...
								else
								{
									...
									else if (this.aiStyle == 50)
									{
										...
										int num463 = 0;
										while ((float)num463 < num462)
										{
											float num464 = (float)Main.rand.Next(-10, 11);
											float num465 = (float)Main.rand.Next(-10, 11);
											float num466 = (float)Main.rand.Next(3, 9);
											float num467 = (float)Math.Sqrt((double)(num464 * num464 + num465 * num465));
											num467 = num466 / num467;
											num464 *= num467;
											num465 *= num467;
											num463++;
										}
										...
										else
										{
											...
											else
											{
												...
												else if (this.aiStyle == 68)
												{
													...
													if (this.alpha == 0)
													{
														Vector2 vector69 = new Vector2(4f, -8f);
														float num696 = this.rotation;
														if (this.direction == -1)
														{
															vector69.X = -4f;
														}
														vector69 = vector69.RotatedBy((double)num696, default(Vector2));
													}
													this.spriteDirection = this.direction;
													if (this.owner == Main.myPlayer && this.timeLeft <= 3)
													{
															...
															else
															{
																...
																else
																{
																	if (this.aiStyle == 87)
																	{
																		...
																		float num859 = (float)(this.width * this.height) * 0.0045f;
																		return;
																	}
																	if (this.aiStyle == 88)
																	{
																	...
																	else if (this.aiStyle == 90)
																	{
																		...
																		if (this.localAI[0] >= 10f)
																		{
																			this.localAI[0] = 0f;
																			int num899 = 17;
																			if ((base.Center - Main.player[Main.myPlayer].Center).Length() < (float)(Main.screenWidth + num899 * 16))
																			{
																				int num900 = (int)base.Center.X / 16;
																				int num901 = (int)base.Center.Y / 16;
																				for (int num902 = num900 - num899; num902 <= num900 + num899; num902++)
																				{
																					for (int num903 = num901 - num899; num903 <= num901 + num899; num903++)
																					{
																						if (Main.rand.Next(4) == 0)
																						{
																							Vector2 vector137 = new Vector2((float)(num900 - num902), (float)(num901 - num903));
																							if (vector137.Length() < (float)num899 && num902 > 0 && num902 < Main.maxTilesX - 1 && num903 > 0 && num903 < Main.maxTilesY - 1 && Main.tile[num902, num903] != null && Main.tile[num902, num903].active())
																							{
																								bool flag39 = false;
																								if (Main.tile[num902, num903].type == 185 && Main.tile[num902, num903].frameY == 18)
																								{
																									if (Main.tile[num902, num903].frameX >= 576 && Main.tile[num902, num903].frameX <= 882)
																									{
																										flag39 = true;
																									}
																								}
																								else if (Main.tile[num902, num903].type == 186 && Main.tile[num902, num903].frameX >= 864 && Main.tile[num902, num903].frameX <= 1170)
																								{
																									flag39 = true;
																								}
																							}
																					...
																					else
																					{
																						...
																						else if (this.aiStyle == 108)
																						{
																							...
																							if (this.ai[0] <= 90f)
																							{
																								...
																								if (this.type == 578)
																								{
																									Vector2 vector165 = this.ai[1].ToRotationVector2();
																									Vector2 vector166 = vector165.RotatedBy(1.5707963705062866, default(Vector2)) * (float)(Main.rand.Next(2) == 0).ToDirectionInt() * (float)Main.rand.Next(10, 21);
																									vector165 *= (float)Main.rand.Next(-80, 81);
																									Vector2 vector167 = vector165 - vector166;
																									vector167 /= 10f;
		...
		private void AI_001()
		{
			...
			if (this.type == 638)
			{
				...
				if (flag2)
				{
					int num101 = Main.rand.Next(15, 31);
				}
			}
		...
		private void AI_075()
		{
			...
			if (this.type == 460)
			{
				...
				if (this.ai[0] > 10f && !flag5)
				{
					...
					vector17 = vector17.RotatedBy((double)(this.rotation - 1.57079637f), default(Vector2));
					Vector2 vector18 = base.Center + vector17;
					for (int k = 0; k < num18 + 1; k++)
					{
						int num21 = 226;
						float num22 = 0.4f;
						if (k % 2 == 1)
		...
		public void Kill()
		{
			...
			if (this.type == 405)
			{
				...
				Vector2 arg_3352_0 = base.Center;
			}
			if (this.type == 501)
			{
			...
			{
				Main.PlaySound(2, (int)this.position.X, (int)this.position.Y, 54);
				Vector2 arg_3824_0 = base.Center;
			}
			...
			if (this.type == 507 || this.type == 508)
			{
				...
				vector25 += oldVelocity * 16f;
			}
			if (this.type == 598)
			{
				Main.PlaySound(0, (int)this.position.X, (int)this.position.Y, 1);
				Vector2 vector26 = this.position;
				Vector2 vector27 = (this.rotation - 1.57079637f).ToRotationVector2();
				vector26 += vector27 * 16f;
			}
			...
			else if (!Main.projPet[this.type])
			{
				...
				{
					Main.PlaySound(2, (int)this.position.X, (int)this.position.Y, 10);
					for (int num430 = 0; num430 < 60; num430++)
					{
						int num431 = Main.rand.Next(3);
						if (num431 == 0)
						{
							num431 = 15;
						}
				...
				else if (this.type == 9 || this.type == 12 || this.type == 503)
				{
					...
					for (int num435 = 0; num435 < num433; num435++)
					{
						int num436 = Main.rand.Next(16, 18);
						if (this.type == 503)
						{
							num436 = 16;
						}
