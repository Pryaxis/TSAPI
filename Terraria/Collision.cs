...
namespace Terraria
{
	public class Collision
	{
		...
		public static bool CanHit(Microsoft.Xna.Framework.Vector2 Position1, int Width1, int Height1, Microsoft.Xna.Framework.Vector2 Position2, int Width2, int Height2)
		{
		...
		public static bool DrownCollision(Microsoft.Xna.Framework.Vector2 Position, int Width, int Height, float gravDir = -1f)
		{
			Microsoft.Xna.Framework.Vector2 vector = new Microsoft.Xna.Framework.Vector2(Position.X + (float)(Width / 2), Position.Y + (float)(Height / 2));
			int num = 10;
			int num2 = 12;
			if (num > Width)
			{
			...
			vector = new Microsoft.Xna.Framework.Vector2(vector.X - (float)(num / 2), Position.Y + -2f);
			if (gravDir == -1f)
			{
		...
		public static bool WetCollision(Microsoft.Xna.Framework.Vector2 Position, int Width, int Height)
		{
			Microsoft.Xna.Framework.Vector2 vector = new Microsoft.Xna.Framework.Vector2(Position.X + (float)(Width / 2), Position.Y + (float)(Height / 2));
			int num = 10;
			int num2 = Height / 2;
			...
			vector = new Microsoft.Xna.Framework.Vector2(vector.X - (float)(num / 2), vector.Y - (float)(num2 / 2));
			int num3 = (int)(Position.X / 16f) - 1;
			int num4 = (int)((Position.X + (float)Width) / 16f) + 2;
			int num5 = (int)(Position.Y / 16f) - 1;
			int num6 = (int)((Position.Y + (float)Height) / 16f) + 2;
		...
		public static Microsoft.Xna.Framework.Vector2 TileCollision(Microsoft.Xna.Framework.Vector2 Position, Microsoft.Xna.Framework.Vector2 Velocity, int Width, int Height, bool fallThrough = false, bool fall2 = false)
		{
			Collision.up = false;
			Collision.down = false;
			Microsoft.Xna.Framework.Vector2 result = Velocity;
			Microsoft.Xna.Framework.Vector2 vector = Velocity;
			Microsoft.Xna.Framework.Vector2 vector2 = Position + Velocity;
			Microsoft.Xna.Framework.Vector2 vector3 = Position;
			int num = (int)(Position.X / 16f) - 1;
			int num2 = (int)((Position.X + (float)Width) / 16f) + 2;
			int num3 = (int)(Position.Y / 16f) - 1;
			int num4 = (int)((Position.Y + (float)Height) / 16f) + 2;
		...
		public static bool SolidCollision(Microsoft.Xna.Framework.Vector2 Position, int Width, int Height)
		{
			int num = (int)(Position.X / 16f) - 1;
			int num2 = (int)((Position.X + (float)Width) / 16f) + 2;
			int num3 = (int)(Position.Y / 16f) - 1;
		...
		public static Microsoft.Xna.Framework.Vector2 AnyCollision(Microsoft.Xna.Framework.Vector2 Position, Microsoft.Xna.Framework.Vector2 Velocity, int Width, int Height)
		{
			Microsoft.Xna.Framework.Vector2 result = Velocity;
			Microsoft.Xna.Framework.Vector2 vector = Velocity;
			Microsoft.Xna.Framework.Vector2 vector2 = Position + Velocity;
		...
		public static void HitTiles(Microsoft.Xna.Framework.Vector2 Position, Microsoft.Xna.Framework.Vector2 Velocity, int Width, int Height)
		{
			Microsoft.Xna.Framework.Vector2 vector = Position + Velocity;
			int num = (int)(Position.X / 16f) - 1;
			int num2 = (int)((Position.X + (float)Width) / 16f) + 2;
		...
		public static bool SwitchTiles(Microsoft.Xna.Framework.Vector2 Position, int Width, int Height, Microsoft.Xna.Framework.Vector2 oldPosition)
		{
			int num = (int)(Position.X / 16f) - 1;
			int num2 = (int)((Position.X + (float)Width) / 16f) + 2;
			int num3 = (int)(Position.Y / 16f) - 1;
