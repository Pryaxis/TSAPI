			...
			else
			{
				...
				else
				{
					...
					else if (b == 10 && Main.netMode == 1)
					{
						...
						for (int num23 = num21; num23 < num21 + (int)num20; num23++)
						{
							...
							if (Main.tile[num23, num22].active())
							{
								...
								else if (!flag5 || (int)Main.tile[num23, num22].type != type2)
								{
					...
					else if (b == 13)
					{
						...
						if (Main.netMode == 1)
						{
							bool arg_24FB_0 = Main.player[num27].active;
						}
						if (Main.netMode == 2)
						{
							num27 = this.whoAmI;
					...
					else
					{
						...
						if (b == 33)
						{
							...
							if (Main.netMode == 1)
							{
								...
								else if (Main.player[Main.myPlayer].chest != num81 && num81 != -1)
								{
									Main.playerInventory = true;
									Main.PlaySound(12, -1, -1, 1);
								}
								else if (Main.player[Main.myPlayer].chest != -1 && num81 == -1)
								{
						...
						else
						{
							...
							else if (b == 42)
							{
								...
								else if (Main.myPlayer == num88 && !Main.ServerSideCharacter)
								{
									return;
								}
							...
							else
							{
								...
								else if (b == 50)
								{
									...
									else if (num108 == Main.myPlayer && !Main.ServerSideCharacter)
									{
										return;
									}
									for (int num109 = 0; num109 < 22; num109++)
									{
