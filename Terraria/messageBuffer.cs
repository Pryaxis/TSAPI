											...
											else
											{
												...
												else
												{
													if (b == 13)
													{
														...
														if (Main.netMode == 1)
														{
															bool arg_243A_0 = Main.player[num27].active;
														}
														if (Main.netMode == 2)
														{
															num27 = this.whoAmI;
																					...
																					else
																					{
																						...
																						else
																						{
																							if (b == 23 && Main.netMode == 1)
																							{
																								...
																								if (num51 <= 0)
																								{
																									Main.npc[(int)num50].active = false;
																								}
																								...
																								else
																								{
																									...
																									else
																									{
																										if (b == 26)
																										{
																											...
																											Main.player[(int)b24].Hurt((int)num61, num60, pvp, true, string4, crit);
																											if (Main.netMode == 2)
																											{
																												NetMessage.SendData(26, -1, this.whoAmI, string4, (int)b24, (float)num60, (float)num61, (float)b25, (int)b26);
																												return;
																											}
																										}
																										else
																											...
																											else
																											{
																												if (b == 28)
																												{
																													...
																													if (num70 >= 0)
																													{
																														if (num73 == 1)
																														{
																															Main.npc[(int)num69].StrikeNPC((int)num70, num71, num72, true, false);
																														}
																														else
																														{
																															Main.npc[(int)num69].StrikeNPC((int)num70, num71, num72, false, false);
																														}
																													}
																													else
																													{
																																								...
																																								else
																																								{
																																									...
																																									else
																																									{
																																										if (b == 44)
																																										{
																																											...
																																											Main.player[(int)b34].KillMe((double)num91, num90, pvp2, string6);
																																											if (Main.netMode == 2)
																																											{
																																												NetMessage.SendData(44, -1, this.whoAmI, string6, (int)b34, (float)num90, (float)num91, (float)b35, 0);
																																												return;
																																											}
																																										}
																																										else
																																																		...
																																																		else
																																																		{
																																																			...
																																																			else
																																																			{
																																																				if (b == 55)
																																																				{
																																																					...
																																																					{
																																																						Main.player[(int)b39].AddBuff((int)b40, (int)num114, true);
																																																						return;
																																																					}
																																																					if (Main.netMode == 2)
																																																					{
																																																						NetMessage.SendData(55, (int)b39, -1, "", (int)b39, (float)b40, (float)num114, 0f, 0);
																																																						return;
																																																					}
																																																				}
																																																				else
